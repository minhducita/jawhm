	  ...
	  <?php echo $header_obj->breadcrumbs(); ?>
		...
		<div style="border: 2px dotted navy; font-size:10pt; margin: 10px 10px 25px 10px; padding: 10px 20px 10px 20px;">
			...
			<br/>
				...
				<center>
					<a href="http://www.jawhm.or.jp/ja/5079"><img  src="http://www.jawhm.or.jp/ja/wp-content/uploads/2013/11/cda9a889e9b5e5e8704e810df86f8a8e.gif" width="49%"/></a> <a href="/support/"><img src="http://www.jawhm.or.jp/ja/wp-content/uploads/2014/01/409254b86e7f8b5bdfba2db41f56e93f.gif" width="49%"></a>
				</center>
	...
	<table style="margin-left:15px;">
		...
		<tr>
			...
			<td>
				...
				<div class="chiiki" style="background-color:#00a898" id="iwate">岩手</div>
				...
				<div class="chiiki" style="background-color:#ea3420" id="nagasaki">長崎</div>

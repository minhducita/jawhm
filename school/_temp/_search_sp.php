...
<div id="maincontent">
    <?php echo $header_obj->breadcrumbs(); ?>
          ...
          <section class="voiceBan">
            ...
            <p>
              各国、語学学校の卒業生さんからメッセージが届いています！</br>
              語学学校を選ぶ際に、ぜひ参考にしてみてください♫ </br>
            </p>

            <?php
              include_once("./voice/_sponsors.php");
              shuffle( $sponsors );
              
             $spos = array_slice( $sponsors , 0, 6 );

            ?>

            <div class="row clearfix">
                <div id="voice-search-slide">

                  <?php foreach($spos as $company) { ?>

                    <div>
                      <div class="slide-img">
                         <img src="<?php echo '/school/voice/'.$company[0].'/flip.png'; ?>" alt="More about <?php echo $company[0]; ?>" />
                      </div>
                    </div>
                  <?php }; ?>
                </div>

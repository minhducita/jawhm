<?php	
	...
	class HeaderFooter
	{
		...
		public function display_header()
		{
			...
			echo '
			<link href="/fra/css/base.css" rel="stylesheet" type="text/css" />
			<link href="/fra/css/headhootg-nav.css" rel="stylesheet" type="text/css" />
			<link href="/fra/css/contents.css" rel="stylesheet" type="text/css" />
			';
			...
			';
				...
				echo'
				<div id="header">
					<h1><a href="/fra/"><img src="images/h1-logo.jpg" alt="日本ワーキングホリデー協会" width="475" height="33" /></a></h1>
					<div id="utility-nav">
						<ul>

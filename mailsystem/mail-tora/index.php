...
print '
	<div style="position:absolute; top: 100px; left:50px; border:1px solid navy; background-color:orange; color:white; font-size:12pt; font-weight:bold; padding:20px 20px 20px 20px; width:80%; text-align:center;">
		...
		&nbsp;<br/>
		<input type="button" value="tokyo@tora-tora.net" style="width:300px;" onclick="document.getElementById(\'rcmloginuser\').value=\'tokyo+tora-tora.net\'; document.getElementById(\'rcmloginpwd\').value=\'124trave123\'; document.form.submit();">
		<br/>&nbsp;<br/>
		<input type="button" value="osaka@tora-tora.net" style="width:300px;" onclick="document.getElementById(\'rcmloginuser\').value=\'osaka+tora-tora.net\'; document.getElementById(\'rcmloginpwd\').value=\'124trave123\'; document.form.submit();">
		<br/>&nbsp;<br/>
	</div>
	...
	<div style="position:absolute; top: 20px; left:50px; border:1px solid navy; background-color:orange; color:white; font-size:12pt; font-weight:bold; padding:20px 20px 20px 20px; width:80%; text-align:center;">
		<a href="http://www.jawhm.or.jp/mailsystem/mail">協会メールへ</a><br/>
	</div>

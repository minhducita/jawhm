<?php
	...
	require_once 'fnc_functions.php';

	require_once 'fnc_dbopen.php';
	try {
		// アクセスログ記録
		$sql  = 'INSERT INTO log (';
	...
	$url_base = '/mailsystem/mem/';
	$url_full = BASE_URL.$url_base;     /* Khang comment */
//	$url_full = ''.$url_base;
	...
	require_once 'fnc_inputfield.php';

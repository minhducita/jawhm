...
switch ($data_param)	{
				...
				<table>
					...
					<tr>
						...
						<td colspan="3">
							...
							　　除外キーワード　'.field_text('ser_notkeyword', 20, '').'
						</td>
					</tr>
	...
	case "event_show":
		...
		$msg = '
			<div id="div_event_edit" style="display:none; margin:10px 20px 10px 20px; font-size:10pt; cursor:default; overflow-y:auto; height: 530px;">
				...
				<table>
					<tr>
						...
						<td class="infield" width="360" colspan="3">
							<input type="checkbox" id="edit_use" name="edit_use" '.$cur_use.'>本掲載　
							<input type="checkbox" id="edit_schoolap" name="edit_schoolap" '.$cur_schoolap.'>学校　
	...
	case "event_edit":
		...
		try {
			if ($edit_id == '')	{
				...
				$sql .= ' hiduke, starttime, endtime, place, k_use, k_title1, k_title2, k_desc1, k_desc2, k_stat, free, type, pax, new, seminar_name, short_description, country_code, indicated_option, broadcasting, group_color, ongoogle, mailinfo, beginer, schoolap ';
				$sql .= ') VALUES (';
				$sql .= ' :hiduke, :sttime, :edtime, :place, :k_use, :k_title1, :k_title2, :k_desc1, :k_desc2, :k_stat, :free, :type, :pax, :new, :seminar_name, :short_description, :country_code, :indicated_option, :broadcasting, :group_color, :ongoogle, :mailinfo, :beginer, :schoolap ';
				$sql .= ')';
				$stt2 = $db->prepare($sql);

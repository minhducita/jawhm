CoolClock.config.skins = {
	...
	jawhm/*wasclassic/*was gIG*/: {
		outerBorder:      { lineWidth: 186, radius: 1, color: "#FFF", alpha: 1 },
		smallIndicator:   { lineWidth: 3, startAt: 89, endAt: 94, color: "#666", alpha: 1 },
		largeIndicator:   { lineWidth: 5, startAt: 83, endAt: 94, color: "#666", alpha: 1 },
		hourHand:         { lineWidth: 6, startAt: 0, endAt: 50, color: "black", alpha: 1 },
		minuteHand:       { lineWidth: 5, startAt: 0, endAt: 70, color: "black", alpha: 1 },
		secondHand:       { lineWidth: 2, startAt: -20, endAt: 75, color: "red", alpha: .85 },
		secondDecoration: { lineWidth: 4, startAt: 0, radius: 2, fillColor: "black", color: "black", alpha: 1 }
	},

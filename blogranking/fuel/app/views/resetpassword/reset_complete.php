...
<meta property="og:image" content="http://www.jawhm.or.jp/assets/img/fb-image.jpg" />
...
<!--▲facebook OGP▲-->
<link rel="shortcut icon" href="http://www.jawhm.or.jp/assets/img/favicon.ico" type="image/x-icon" />
<title>パスワードリセット-リセット完了- | 日本ワーキング・ホリデー協会</title>
...
<!--[if lte IE 8 ]>
  <link rel="stylesheet" href="/calendar_module/assets/css/cal_module_ie.css" />
<![endif]-->
</head>
...
<body>
  <div id="header">
    ...
    <img id="top-mainimg" src="/assets/img/blog/legi-topbanner.jpg" alt="" width="970" height="170" />
  </div><!-- / #header -->
    ...
    <div id="contentswide">
      <div id="maincontentwide">
        <div style="padding-left:30px; float:clear;">
          <p class="title_bar">パスワードリセット完了</p>
          <p class="txtcomplate">
              入力していただいたメールアドレス宛に初期化したパスワードを記載したメールをお送りいたしました。
              <br>
              記載されているパスワードでログインし、速やかにパスワードの変更をお願いします。
              <br>
              パスワードの記載したメールが届かない場合は、有効期限が切れている可能性がありますので、再度パスワードリセットをお願いします。
          </p>

          <div class="btnLogin opacity"><a href="<?php echo SYSTEM_ROOT_PATH?>/login/"><img src="/assets/img/blog/btn_login.jpg" alt="ログイン画面はこちら"></a></div>
        </div>

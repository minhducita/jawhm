  	...
  	<div id="contentswide" class="myPage">
        ...
        <section>
            ...
            <table class="mypageTable">
              ...
              <tr>
                <th>パスワード</th><td><?php echo ($pass=="" ? "(変更なし)" : hidden_chars($pass));?></td>
              </tr>
            </table>
            ...
            <table class="mypageTable2">
              <tr>
                <th>ハンドル名 </th><td><?php echo $handlename?></td>
                <td rowspan="14" class="rowImg"><?php
                    if(basename($img_path) != "t_prof"){
                        echo '<img src="'.$img_path.'" width="200">';
                    }else{
                        echo "<br>新規アップロードなし";
                    }
                ?></td>
              ...
              <tr>
                <th>ブログタイトル</th><td><?php echo $blogtitle?></td>
              </tr>
              <tr>
                <th>ブログURL</th><td><?php echo $blogurl?></td>
              </tr>
              <tr>
                <th>ブログRSS</th><td><?php echo $blogrss?></td>
              </tr>
              <tr>
                <th>サイト紹介文</th><td><?php echo nl2br($blogdesc)?></td>
              </tr>
              <tr>
                <th>参加カテゴリー</th>
                <td>
...
<center>上記の通り、登録情報を変更いたします。よろしければ「次へ」を押してください</center>
<br />
            <form id="editFor" method="post" action="<?php echo SYSTEM_ROOT_PATH?>/mypage/edit/update">
              <input type="hidden" name="act" value="s2">
              <input type="hidden" name="email" value="<?php echo $email?>">
              <input type="hidden" name="pass" value="<?php echo $pass?>">
              <input type="hidden" name="handlename" value="<?php echo $handlename?>">
              <input type="hidden" name="blogtitle" value="<?php echo $blogtitle?>">
              <input type="hidden" name="blogurl" value="<?php echo $blogurl?>">
              <input type="hidden" name="blogrss" value="<?php echo $blogrss?>">
              <input type="hidden" name="blogdesc" value="<?php echo $blogdesc?>">
              <input type="hidden" name="category" value="<?php echo $category?>">
              <input type="hidden" name="gender" value="<?php echo $gender?>">

              <div id="btnArea2">
                <input type="button" class="back btnBack" value="<< 戻る" onclick="history.back();" >
                <input type="submit" value="登録する" class="btnRegister" />
              </div><!-- / #btnArea -->
         		</form>

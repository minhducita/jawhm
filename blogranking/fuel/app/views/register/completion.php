...
<title>ブログランキング登録-登録完了- | 日本ワーキング・ホリデー協会</title>
  ...
  <div id="contentsbox">
  	...
  	<div id="contentswide">
        ...
        <div style="margin:10px 0 0 30px;">
          ...
          <div id="stepBox3" class="stepBox">STEP3　登録完了</div><!-- / #stepBox1 -->
          <table id="stepDetail">
            <tr>
        	...
        	<p class="title_bar">登録完了</p>
          <p class="txtcomplate">登録完了しました。サンプルテキストサンプルテキストサンプルテキストサンプルテキストサンプルテキストサンプルテキスト</p>

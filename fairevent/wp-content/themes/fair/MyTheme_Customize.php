...
function theme_customize_register($wp_customize) {
    ...
    $wp_customize->add_setting('bg_center_type', array(
        'capability' => 'edit_theme_options',
        'transport' => 'refresh',
    ));
    $wp_customize->add_control('bg_center_type_c', array(
        'section' => 'general',
        'settings' => 'bg_center_type',
        'label' => '中央BG表示形式',
        'type' => 'radio',
        'choices'        => array(
                '敷き詰め'   => __( 'repeat' ),
    ...
    $wp_customize->add_setting('header_nav', array(
        'capability' => 'edit_theme_options',
        'transport' => 'refresh',
    ));
    $wp_customize->add_control('header_nav_c', array(
        'section' => 'general',
        'settings' => 'header_nav',
        'label' => 'ヘッダーグロナビ非表示',
        'type' => 'checkbox',
    ));
    $wp_customize->add_setting('footer_nav', array(
        'capability' => 'edit_theme_options',
        'transport' => 'refresh',
    ));
    $wp_customize->add_control('footer_nav_c', array(
        'section' => 'general',
        'settings' => 'footer_nav',
        'label' => 'フッターグロナビ非表示',
        'type' => 'checkbox',
...
function get_bg_center_type() {
    return esc_url_raw(get_theme_mod('bg_center_type'));
}
add_action('customize_register', 'get_bg_center_type');
...
function get_header_nav() {
    return get_theme_mod('header_nav');
}
add_action('customize_register', 'get_header_nav');

function get_footer_nav() {
    return get_theme_mod('footer_nav');
}
add_action('customize_register', 'get_footer_nav');

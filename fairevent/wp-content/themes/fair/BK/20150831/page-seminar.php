...
$end_date = ($view == "all") ? get_end_date() : date('Y-m-d',strtotime('+10 day'));
...
if (wp_is_mobile()) {
    $config = array(
        ...
        'list' => array(
            'place_default' => $place,
            'title3' => array($title,  get_keyword()),
    ...
    <section class="normalBox">
        ...
        <div class="contentBox noPad">        
            ...
            <section class="semListArea">            	
                ...
                <?php if ($view != 'all') : ?>
                <div class="btnShadow2 mgt30 spview"><a id="moreSeminar" class="btn moreView" href="<?php echo '/fair/seminar/?place='.$place.'&title='.$title.'&view=all'; ?>"><span>もっと見る</span></a></div>
                <?php endif; ?>
            </section><!-- /.semListArea -->         
        </div><!-- /.contentBox -->         
    </section><!-- /.normalBpx -->

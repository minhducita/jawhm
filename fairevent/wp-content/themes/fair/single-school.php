...
if($start = get_start_date()) $start_date = $start;
$end_date = '';
if($end = get_end_date()) $end_date = $end;
if (wp_is_mobile()) {
    $config = array(
        'view_mode' => 'list',
                ...
                <div id="slideBox" style="margin-left:-20px;"> 
                        <div class="pix_diapo">
                            ...
                            <?php if (!empty($slide['video'])) : ?>
                                <iframe class="iframe_video" style="width: 100%; height:50vw;" src="<?php echo $slide['video']; ?>" data-fake="<?php echo $slide['image']; ?>" frameborder="0"></iframe>

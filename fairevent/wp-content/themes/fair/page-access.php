        ...
        <div class="contentBox">        
            ...
            <?php if (!get_access_tokyo_status()): ?>
                <section class="areaBox" id="tokyo">
                    ...
                    <div class="btnShadow2 mgb20 w90"><a class="btn Orng" style="background: <?php echo !get_access_button_color() ?> !important" href="<?php echo get_home_url( $blog_id ); ?>/seminar/?place=tokyo">東京開催のセミナーはこちら</a></div>
                    <div class="mapArea">
            ...
            <?php if (!get_access_osaka_status()): ?>
                <section class="areaBox" id="osaka">
                    ...
                    <div class="btnShadow2 mgb20 w90"><a class="btn Orng" style="background: <?php echo !get_access_button_color() ?> !important" href="<?php echo get_home_url( $blog_id ); ?>/seminar/?place=osaka">大阪開催のセミナーはこちら</a></div>
                    <div class="mapArea">
            ...
            <?php if (!get_access_nagoya_status()): ?>
                <section class="areaBox" id="nagoya">
                    ...
                    <div class="btnShadow2 mgb20 w90"><a class="btn Orng" style="background: <?php echo !get_access_button_color() ?> !important" href="<?php echo get_home_url( $blog_id ); ?>/seminar/?place=nagoya">名古屋開催のセミナーはこちら</a></div>
                    <div class="mapArea">
            ...
            <?php if (!get_access_fukuoka_status()): ?>
                <section class="areaBox" id="fukuoka">
                    ...
                    <div class="btnShadow2 mgb20 w90"><a class="btn Orng" style="background: <?php echo !get_access_button_color() ?> !important" href="<?php echo get_home_url( $blog_id ); ?>/seminar/?place=fukuoka">福岡開催のセミナーはこちら</a></div>
                    <div class="mapArea">

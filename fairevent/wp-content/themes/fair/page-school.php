    ...
    <section class="normalBox">
        ...
        <div class="contentBox noPad">        
            <p class="planeText mgb20">
                ワーキングホリデー＆留学フェアには世界中から30校以上の海外語学学校スタッフのみなさまがオンラインにてセミナーを行います。気になる語学学校がありましたらぜひこの機会にセミナーにお越しください！
            </p><!-- /.planeText -->            
            <div class="srcArea" id="rePoint">
                <h3>学校を希望のジャンルから探す</h3>
            ...
            foreach ($terms as $term):
                ...
                $loop_temp .= $loop_li;
                $loop_temp .= '<div class="clearfix mgt100 mgb60"><a href="#rePoint" class="btn Navy3 right w60">ジャンル選択に戻る</a></div>';
                $loop_temp .= '</div>';

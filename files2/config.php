...
function ft_settings_external_load() {
  ...
  define("USERNAME", "jawhm"); // Your default username.
  define("PASSWORD", "303pittst"); // Your default password.

  $ft["settings"]["DIR"]               = "../img"; // Your default directory. Do NOT include a trailing slash!

...
@session_start();
	...
	class Links
	{
		...
		public $link_contents = array(
			...
			array( "/advanced/frontend/qa/qa_aus.html"                           , "オーストラリアのＱ＆Ａ"                              , "オーストラリア,ＱＡ"                         ),
            ...
            //JN:new
            array( "/country/hungary/index.html"            , "ハンガリーの国情報"                                , "ハンガリー,国情報"                         ),
            array( "/visa/v-hun.html"                       , "ハンガリービザ情報"                              , "ハンガリー,ビザ"                         ),
		);
		...
		public function display_links($contents = '')
		{
			...
			$pagecont = explode(',', $this->page_contents);

...
$qscon = $bien->questions_sort_status;
$count = 0;
foreach ($qscon as $qscon):
    ...
    <div class="mobile" style="padding: 20px;
        ...
        <ul style="list-style-type: disc;">
            <li style="text-align: justify;font-size: 12px;font-weight: bold;"><a href="/wh/australia/">オーストラリアのワーキングホリデーについて</a></li>
            <li style="text-align: justify;font-size: 12px;font-weight: bold;"><a href="/visa/v-aus.html">オーストラリアのワーキングホリデーのビザについて</a></li>
        </ul>
    </div>
    ...
    <div style="float: left; margin-bottom: 20px; width: 100%;">    </div>
    <?php //JN:end ?>

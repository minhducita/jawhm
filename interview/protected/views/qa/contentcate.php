...
<div id="maincontent">
    ...
    <!--JN:disable    <div id="topic-path">
        <div id="text-home"><a href="/">ワーキング・ホリデー（ワーホリ）協会</a>&nbsp;&gt;&nbsp;<a href="../../qa.html" title="">ワーキングホリデー協定国別・よくある質問</a>&nbsp;&gt;&nbsp;<?php echo $slug; ?></div>
    </div>-->
    <?php //JN:code
...
// $bien = Category::find()->where(['id' => $id, 'status' => 1])->one();
    ...
    if (!empty($bien)):// if 1
        ...
        ?>
        <!--   Phần 1-->      
        <h2 style="margin-top:0px"  id="<?php echo "question_seminar"; ?>" class="sec-title"><?= $bien->title ?></h2>
    ...
    <?php if (!empty($bien->description)): ?>
        ...
        if (!empty($bien)): // if 2
            foreach ($bien as $bien): // for 1
                ...
                $question = $bien->frontend_questions;  // frontend_questions at model Category

...
<div class="row tags-bg drop-menu" style ="<!--background-color:#286497;-->" >
...
<div class="row tags-bg" style ="<!--background-color:#286497;-->" >
		...
		<div class="list drop-menu" id="collapse10" style="display:none; background-color:#fff; margin-bottom:5px; margin-top:5px;">
		...
		<ul class="categories">
			<?php
				if (is_category( )) { // if vieweing on category page
					...
					wp_list_categories ('title_li=&child_of=' . $parentcatid);

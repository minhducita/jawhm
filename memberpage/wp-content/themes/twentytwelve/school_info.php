...
';
		...
		if ($p_id == 217) { // IH Brisbane (International House Brisbane)
			...
			$img_link = network_home_url() . 'wp-content/uploads/sites/2/2015/02/ihbrisbane_info.jpg';
...
/* ================= カナダの学校 ==================== */
	if ($blog_id == 3) { 
		...
		if ($p_id == 2) { // 語学学校 ユーロセンター・カナダ School (eurocentres)
			...
			$school_name = 'Eurocentres Canada';
			$school_link = 'www.jawhm.or.jp/school/can_eurocentres/';
			$img_link = network_home_url() . 'wp-content/uploads/sites/3/2014/11/eurocentres_info.jpg';
			$link = 'www.languagecanada.com/';
			$info = 'ユーロセンターズ・カナダは、設立当初より学生第一をポリシーにしています。 英語を母国語とする教師陣は、ランゲージズ・カナダから認定済みであり、高いスタンダードを誇ります。 学校の内外で素晴らしい留学体験ができるよう、教師やスタッフ全員が、学生のケアーと安全を念頭に日々努めています。 ユーロセンター・カナダのバンクーバー校とトロント校では、各学生の留学目標に答えるための個人指導が徹底されています。 学業カウンセリング、自習アドバイス、定期試験、模擬試験、毎週の個人面談など、常に学生の習熟度は評価されているので、流暢さと正確さ双方において、より効率よく英語力を高めることができます。毎週催されるアクティビティーに参加すれば、世界各国に友達の輪を広げることができるでしょう。 ';
		}

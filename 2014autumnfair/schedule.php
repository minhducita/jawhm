...
.fbox:after {
    ...
    border-top: 40px solid #fbfbfb; /*10px*/
}
.fbox:before {
    top: 100%;
    left: 680px;
...
<a name="seminar"></a>
<div class="fbox">
	<p style="width:96%; text-align:left; font-size:12pt; background-color:navy; color:white; padding-left:20px; "><strong>■　お近くの会場をクリックしてください。</p></strong>
...
&nbsp;<br/>
&nbsp;<br/>
	<p style="width:96%; text-align:left; font-size:12pt; background-color:navy; color:white; padding-left:20px; "><strong>■　お好みのセミナーをクリックしてください。</p></strong>

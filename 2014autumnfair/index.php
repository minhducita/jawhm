...
<!--
<h3 id="fair"> <img width="25" src="images/title/1_icon.png">　秋の留学＆ワーキングホリデーフェアは終了致しました。</h3>
&nbsp;<br/>
&nbsp;<br/>
	<center><a href="http://www.jawhm.or.jp/seminar.html"><img src="../images/fair_seminar_off.png" width="40%"></a>　<a href="http://www.jawhm.or.jp/ja/4377"><img src="../images/fair_log_off.png"  width="40%"></a></center><br/>
	</p>
&nbsp;<br/>
	<center><img src="http://www.jawhm.or.jp/event/getlist/img/hana-ani02.gif"> <big><strong>次回の留学・ワーキングホリデーフェアは2013年秋を予定しております。</strong></big> <img src="http://www.jawhm.or.jp/event/getlist/img/hana-ani02.gif"></center>
	<p class="text01">
		当協会留学・ワーキングホリデーフェアは毎年二回、秋（5月～）と秋（10月～）に開催しております。<br/>

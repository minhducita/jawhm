<?php /* Smarty version Smarty-3.1.21, created on 2016-03-14 11:34:54
         compiled from "/var/www/html/jawhmcart/design/backend/templates/views/companies/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:47931140256e677aed25789-25556311%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ae788b57d8ab79fc83b0c52c3a6d8074393987cc' => 
    array (
      0 => '/var/www/html/jawhmcart/design/backend/templates/views/companies/update.tpl',
      1 => 1457504376,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '47931140256e677aed25789-25556311',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56e677af4c10c0_02944198',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56e677af4c10c0_02944198')) {function content_56e677af4c10c0_02944198($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/jawhmcart/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_unpuny')) include '/var/www/html/jawhmcart/app/functions/smarty_plugins/modifier.unpuny.php';
...
?><?php
fn_preload_lang_vars(array('use_existing_store','store','none','recommended','information','vendor_name','storefront_url','ttc_storefront_url','secure_storefront_url','design','store_theme','goto_theme_configuration','status','active','pending','new','disabled','language','create_administrator_account','vendor_commission','contact_information','contact_information','email','phone','url','fax','shipping_address','shipping_address','address','city','country','select_country','state','select_state','zip_postal_code','settings','company','description','text_all_categories_included','redirect_customer_from_storefront','entry_page','none','index','all_pages','countries','shipping_methods','available_for_vendor','disabled','no_data','menu','view_vendor_products','view_vendor_categories','view_vendor_users','view_vendor_orders','delete','editing_vendor','new_vendor'));
?>

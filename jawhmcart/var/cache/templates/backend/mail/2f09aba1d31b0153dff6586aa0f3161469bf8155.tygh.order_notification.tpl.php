<?php /* Smarty version Smarty-3.1.21, created on 2016-03-14 13:30:02
         compiled from "/var/www/html/jawhmcart/design/backend/mail/templates/orders/order_notification.tpl" */ ?>
<?php /*%%SmartyHeaderCode:60774408556e66e62cea9c9-32992282%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2f09aba1d31b0153dff6586aa0f3161469bf8155' => 
    array (
      0 => '/var/www/html/jawhmcart/design/backend/mail/templates/orders/order_notification.tpl',
      1 => 1457951394,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '60774408556e66e62cea9c9-32992282',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21',
  'unifunc' => 'content_56e66e633f3b80_83967241',
  'variables' => 
  array (
    'order_info' => 0,
    'order_status' => 0,
...
<?php if ($_valid && !is_callable('content_56e66e633f3b80_83967241')) {function content_56e66e633f3b80_83967241($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/jawhmcart/app/functions/smarty_plugins/block.hook.php';
...
?><?php
fn_preload_lang_vars(array('dear','invoice','credit_memo','order_details','invoice','invoice','credit_memo','credit_memo','order_details','phone1_label','phone2_label','fax','web_site','email','order','status','date','payment_method','shipping_method','tracking_number','customer','phone','fax','company','url','bill_to','ship_to','product','quantity','unit_price','discount','tax','subtotal','deleted_product','sku','free','free','subtotal','including_discount','order_discount','coupon','taxes','included','tax_exempt','payment_surcharge','shipping_cost','total_cost','customer_notes','admin_text_letter_footer'));
?>
<html>
<head>
        ...
        <td style="background-color: #ffffff; border: 1px solid #e6e6e6; margin: 0px auto 0px auto; padding: 0px 44px 0px 46px; text-align: left;">
            ...
            <tr>
                <td align="left" style="padding-bottom: 3px;" valign="middle">
					<img src="https://www.jawhm.or.jp/jawhmcart/images/jawhm.jpg" alt='jawhm'  style="width:150px">
				</td>                

<?php /* Smarty version Smarty-3.1.21, created on 2016-03-09 13:15:03
         compiled from "/var/www/html/jawhmcart/design/themes/responsive/templates/addons/call_requests/views/call_requests/components/call_requests_content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:99701175456dff7a710eef2-41184142%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '30bad5b060672469efff7ffb0d254c3309313b63' => 
    array (
      0 => '/var/www/html/jawhmcart/design/themes/responsive/templates/addons/call_requests/views/call_requests/components/call_requests_content.tpl',
      1 => 1457518438,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '99701175456dff7a710eef2-41184142',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56dff7a7250017_09480305',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56dff7a7250017_09480305')) {function content_56dff7a7250017_09480305($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include '/var/www/html/jawhmcart/app/functions/smarty_plugins/function.set_id.php';
?><?php
...
_convenient_time" class="ty-control-group__title"><?php echo $_smarty_tpl->__("call_requests.convenient_time");?>
        ...
        <input id="call_data_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_convenient_time" class="ty-input-text cm-cr-mask-time" size="6" type="text" name="call_data[time_from]" value="" placeholder="<?php echo htmlspecialchars(@constant('CALL_REQUESTS_DEFAULT_TIME_FROM'), ENT_QUOTES, 'UTF-8');?>
" /> -
        <input id="call_data_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_convenient_time" class="ty-input-text cm-cr-mask-time" size="6" type="text" name="call_data[time_to]" value="" placeholder="<?php echo htmlspecialchars(@constant('CALL_REQUESTS_DEFAULT_TIME_TO'), ENT_QUOTES, 'UTF-8');?>
" />
    </div>

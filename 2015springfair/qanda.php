...
<div style="float: right;"><a href="./schedule.php" id="button">セミナーを予約する ▶︎︎</a></div><br clear="both" />
&nbsp;<br/>
...
<div style="float: right;"><a href="./schedule.php" id="button">セミナーを予約する ▶︎︎</a></div><br clear="both" />
    ...
    <center><img src="images/line.png"></center>
    &nbsp;<br/>
    <p class="qa"><img src="images/q.png"> 語学留学を考えています。ワーキングホリデー以外でも大丈夫ですか？</p>
    <p class="qa"><img src="images/A.png"> 当協会では語学留学のサポートも行っております。(会員限定)</p>
    <p>気になる学校が見つかったらお気軽にスタッフにご相談くださいませ。 <br/><a href="/ryugakusupport/" target="_blank">当協会の留学サポートについての詳細はこちらをご覧ください。</a><br/>
        （［ご注意］渡航国(アジア、ヨーロッパなど)、また状況によってサポート対象外となる場合がございます。事前にお問い合わせ下さい。）</p></p>
    <div style="float: right;"><a href="./schedule.php" id="button">セミナーを予約する ▶︎︎</a></div><br clear="both" />
&nbsp;<br/>
&nbsp;<br/>
&nbsp;<br/>
...
<!--<a href="./schedule.php#schedule" id="button_wide2">全フェアスケジュール＆ご予約はこちら▶▶︎︎</a><A href="javascript:w=window.open('bamukun.html','','scrollbars=yes,Width=800,Height=700');w.focus();"><img src="images/bakukun_off.png" style="margin-left:70%; margin-top: -80px;"></a>-->
    	...
    	<center><img src="images/back.png" style=" margin-top: -39px; margin-left:-10px; width: 100%;"></center>

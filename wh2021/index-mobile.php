...
$header_obj->add_css_files = '<link href="css/style-mobile.css" rel="stylesheet" type="text/css">';
...
<div id="maincontent">
	...
	<br>
	<div class="text-center"><img class="lazyload" data-src="./images/main_sp.webp" alt="2021 年版 ワーキングホリデー 初心者向け完全ガイド" style="width: 100%; max-width: 460px">
	</div>
	<div>
		<h2 id="top" class="top-text"> 2021 年版 <br> ワーキングホリデー <br> 初心者向け完全ガイド</h2>
		<p>ワーキングホリデーとは、<mark>18 歳～ 30 歳の日本国民が海外で「学ぶ」「働く」「暮らす」といった海外生活が総合的に体験できる制度です。<mark></p><br>
		<p>1980 年 12 月に初めてオーストラリアと日本の間で始まったワーキングホリデー協定は 2020 年で 40 年を迎えました。現在は、26 か国もの協定国があります。(2020 年 12 月時点 )</p><br>
		<p>語学力の向上、海外での就労経験、友人との出会い、異文化理解など・・・日本にいるだけでは味わうことができない経験となるのがワーキングホリデーです。自由に様々なことにチャレンジできるワーキングホリデーは人生の中で一番楽しい、そして自分の価値観をも変えてしまう経験になること間違いなしです。　</p><br>
	...
	<div class="points-block">
		<div class="img"> <img class="lazyload" data-src="./images/point_1.webp" alt="point_1"></div>
		<div class="title">ワーキングホリデープランは自由自在！</div>
		<div class="content">
			<p>ワーキングホリデーとは、日本と協定を結んだ国で 1 ～ 2 年間の滞在が許され、その間に観光、就学、就労ができる特別な制度です。ワーキングホリデー期間はどこに滞在しても、どこを旅行しても、どこで仕事をしても、どこの学校に通ってもよいと、非常に自由度が高いのが特徴です。そのため、みなさんが現地でやりたいことや叶えたい夢を現実にできるチャンスがたくさんあります。</p><br>
	...
	<div class="points-block">
		<div class="img"> <img class="lazyload" data-src="./images/point_2.webp" alt="point_2"></div>
		<div class="title">フルタイムで働きながら海外生活ができる！</div>
		<div class="content">
			<p>ワーキングホリデー中は、その国でのフルタイムの就労が認められています。1 ～ 2 年間という長期間英語漬けの環境で働けるうえ、さらに必要な生活費を現地で稼ぐことができます。貯金ができるくらいお金が稼げる国もあります。そのため、これまで「留学したいけれど費用が高すぎるから…」と諦めていた方にも大変有効です。</p><br>
	...
	<div class="points-block">
		<div class="img"> <img class="lazyload" data-src="./images/point_3.webp" alt="point_3"></div>
		<div class="title">しっかりと英語の勉強もできる！</div>
		<div class="content">
			<p>ワーキングホリデー期間中は、語学学校に通って英語などの言語を勉強することができます。英語を話せるようになりたい、英語を使って現地でお仕事がしたい、さらには現地で進学、就職、日本で転職活動の際に必要な資格が取りたい、などみなさんの目指す姿に合わせて語学学校、およびコースを選ぶことができます。</p><br>
	...
	<div class="countryx-block">
		<div class="header"> <img class="lazyload" data-src="./images/country_aus.webp" alt="australia-country"></div>
		<div class="body">
			<div class="title">美しい海と都会が魅力の国<br>オーストラリア</div>
			<div class="content">
				<p>ワーキングホリデーで 1 番人気の渡航先がオーストラリアです。温暖な気候、大自然、給料、治安など、様々な要因で愛される国です。</p><br>
				<p>フレンドリーな国民性と、日本と時差が１時間しか変わらないことから、海外滞在が初めての人でも安心して生活する事が出来ます。また、最長 3 年間滞在する事が出来るため長く滞在したいという方にもオススメです。</p><br>
	...
	<div class="countryx-block">
		<div class="header"> <img class="lazyload" data-src="./images/country_can.webp" alt="canada-country"></div>
		<div class="body">
			<div class="title"> 雄大な銀世界と多文化の国<br> カナダ </div>
			<div class="content">
				<p>多数の移民でできた国がカナダです。夏はカラッとしていて過ごしやすく、冬は美しい雪景色を楽しむ事が出来ます。</p><br>
				<p>ニューヨークやシアトルなどアメリカの大都市がすぐ近いので、「週末は日帰りアメリカ旅行」といった楽しみ方も出来てしまいます。</p><br>
				<p>カナダ最大のとしトロント、自然と都会が共存したバンクーバー、英語とフランス語の 2 つの言語が公用語であるモントリオールなど、都市によって全く環境が異なるため自分に合った都市が見つけられます。</p>
	...
	<div class="countryx-block">
		<div class="header"> <img class="lazyload" data-src="./images/country_nz.webp" alt="newzealand-country"></div>
		<div class="body">
			<div class="title"> 手つかずの大自然と安全な国<br> ニュージーランド </div>
			<div class="content">
	...
	<div class="countryx-block">
		<div class="header"> <img class="lazyload" data-src="./images/country_uk.webp" alt="newzealand-country"></div>
		<div class="body">
			<div class="title"> 長い歴史を持つ文化と芸術の国<br> イギリス </div>
			<div class="content">
	...
	<div class="countryx-block last-child">
		<div class="header"> <img class="lazyload" data-src="./images/country_ire.webp" alt="newzealand-country"></div>
		<div class="body">
			<div class="title"> ケルト文化溢れるエメラルドの国<br> アイルランド </div>
			<div class="content">
	...
	<p class="pt-10 pb-10">ワーキングホリデー制度には共通のルールがありますので、まずは確認していきましょう。</p>
	...
	<div class="p-10"><img class="lazyload" data-src="./images/visa.webp" alt="各国ビザ条件の比較">
		<div>
	...
	<div class="steps-block">
		<div class="header">【STEP1】まずはワーキングホリデー制度について十分な知識を得よう!</div>
		<div class="body">
			<div class="content">ワーキングホリデーとはどんな制度なのか、どの国に行けるのか、どんなことができるのか、どれくらいの語学力が必要なのか、国や都市の魅力や特徴、ビザ取得の注意点、費用の目安、失敗しない海外渡航のコツ、ビザの上手な使い方などなど、まずはワーキングホリデーに関する基本的な知識を調べましょう！基本的な情報があれば、それだけワーキングホリデーのプランが立てやすくなります。</div>
	...
	<div class="steps-block">
		<div class="header"> 【STEP2】具体的に目的・目標をイメージしよう！</div>
		<div class="body">
	...
	<div class="steps-block">
		<div class="header"> 【STEP3】自分に合った都市 / 語学学校を選ぼう !</div>
		<div class="body">
			<div class="content"> 目的・目標が決まったら、それに合わせてワーキングホリデーをする国、都市、語学学校などを決めましょう。海外には非常に多くの語学学校がありますが、都市や学校ごとに特徴がありますので、あなたのやりたいことが明確になっていればかなり絞り込むことができるはずです。都市や語学学校が決まれば渡航日までの具体的な流れや費用も分かります。</div>
			<div class="text-center">
	...
	<div class="steps-block">
		<div class="header"> 【STEP4】学校申込み / ビザ申請をしよう！</div>
		<div class="body">
	...
	<div class="steps-block">
		<div class="header">【STEP5】出発直前の最終確認！</div>
		<div class="body">
			<div class="content">すべての申込みが終わったら、出発準備の最終段階に入ります。海外保険の手続きやお金の持って行き方、現地での携帯電話、航空券やビザについて、空港での送迎、市役所での手続き、その他日本でやっておかなくてはならないことなどを必ず事前に調べておきましょう。そして最後に荷造りと持ち物の確認ができれば、あなたのワーキングホリデーがスタートします！</div>
			<div class="text-center">
	...
	<br><br>
	<div class="link-img text-center"><a href="/seminar/"><img class="lazyload" data-src="./images/banner_seminar.webp" alt="セミナーの検索・ご予約はこちらから"></a>
		<p class="text-center">▲ セミナーの検索・ご予約はこちらから ▲</p>
	</div>
	<div class="top-move">
		<p><a href="#header">▲TOP に戻る</a></p>
	</div>
	...
	<p class="text01"><mark>「行けば何とかなるだろう」の考えで渡航。</mark>日常会話はできるものの、<mark>現地で働くには英語力が足りないため</mark>、なかなか働き先が見つからない。結果、<mark>英語をあまり使わない日本食レストランでキッチンのアルバイトを</mark>スタート。生活費を稼げるので海外生活は継続できるが、<mark>英語を使わないため語学力が思ったように伸びず</mark>、あっという間に 1 年が経過してしまい、そのまま帰国。海外で 1 年生活していたが<mark>自分の納得のいく経験にならなかった。</mark>
	</p>
	<div class="text-center"><img class="lazyload" data-src="./images/plan_1.webp" alt="日本食レストラン（キッチン）">
	</div>

	<h3 class="h3-01">一般的な成功するワーキングホリデーのプラン</h3>
	<p class="text01">ある程度語学力は必要なことが分かっているので、<mark>まずは基礎力 ( 読む、書く、聞く、話す ) の 4 技能を身に着ける</mark>ために語学学校へ。会話に困らなくなり、現地の生活にも慣れ始めるた<mark>4 ヶ月目から</mark>、海外での仕事を経験するため日本食レストランの接客のアルバイトを始める。6 カ月ほど働いて基本的な接客英語とスキルを身に着けたら、<mark>最後にロー カルでの仕事を経験し</mark>帰国する。語学力はもちろん、<mark>完全に英語の環境で仕事をした経験は、自分の自信にもつながった。</mark>
	</p>
	...
	<p class="text01">ワーキングホリデーで滞在できる期間が決まっているので、<mark>語学学校で勉強する期間を前倒しして、先に学生ビザで 6 ヶ月間しっかり英語力の底上げと専門スキルを身に着ける。</mark>語学学校を終えたらビザをワーキングホリデーに切り替え、英語力とスキルがある状態で仕事探しをスタートできる。そのため日本食のレストランで働く期間も短くなって、すぐにローカルジョブで働けるようになった。時間をかけてしっかりと経験とスキルを身に着けたので、<mark>帰国後の就職 では大きなアドバンテージになった。</mark>
	</p>
	<div class="text-center"><img class="lazyload" data-src="./images/plan_3.webp" alt="語学学校 日本食レストラン（接客）-> ローカル  -> レストラン">
	</div>
	<div class="top-move">
		<p><a href="#header">▲TOP に戻る</a></p>
	</div>
	...
	<ul class="plan-block">
		<li> <a href="#plan_a"> <img class="lazyload" data-src="./images/person_a.webp" alt="person a"> <br> 海外生活を満喫したい</a></li>
		<li> <a href="#plan_b"> <img class="lazyload" data-src="./images/person_b.webp" alt="person b"> <br> 語学力を身につけたい</a></li>
		<li> <a href="#plan_c"> <img class="lazyload" data-src="./images/person_c.webp" alt="person c"> <br> 英語を使って働きたい</a></li>
		<li> <a href="#plan_d"> <img class="lazyload" data-src="./images/person_d.webp" alt="person d"> <br> 就活に活かしたい</a></li>
	</ul>
	<h3 id="plan_a" class="h3-01">とにかく海外の生活を満喫したい！</h3>
	<div class="msg">
		<div class="msg-img"> <img class="lazyload" data-src="./images/person_a.webp" alt="person a"></div>
		<div class="msg-box">
			<div class="arrow">
				<div class="outer"></div>
				<div class="inner"></div>
			...
			<div class="message-body">
				...
				<p>自由に海外生活を楽しみたいけど、英語に自信なくて生活できるか不安・・・</p> <br>
			</div>
		</div>
	</div>
	<div class="msg">
		<div class="msg-img"> <img class="lazyload" data-src="./images/bam.webp" alt="bam"></div>
		<div class="msg-box">
			<div class="arrow">
				<div class="outer"></div>
				<div class="inner"></div>
	...
	<div class="linkbox"><a href="/school">ワーキングホリデー中に通える<br>語学学校についてもっと詳しく知る</a>
	</div>

	<h3 id="plan_b" class="h3-01">しっかり語学力をアップしたい！</h3>
	<div class="msg">
		<div class="msg-img"> <img class="lazyload" data-src="./images/person_b.webp" alt="person b"></div>
		<div class="msg-box">
			<div class="arrow">
				<div class="outer"></div>
				<div class="inner"></div>
	...
	<div class="msg">
		<div class="msg-img"> <img class="lazyload" data-src="./images/person_c.webp" alt="person c"></div>
		<div class="msg-box">
			<div class="arrow">
				<div class="outer"></div>
				<div class="inner"></div>
	...
	<div class="msg">
		...
		<div class="msg-box">
			...
			<div class="message-body">
				<p>海外の人たちと一緒に働きたい！というあなたには、インターンシッププログラムがぴったりです。</p><br>
				<p> 海外で働くためには中上級（TOEIC750 ～ 850 点）の英語力が求められます。無計画にワーキングホリデーをして、「仕事が見つからず、資金も底をつき早期帰国をした」なんていう例も少なくはありません。まずは語学力と専門知識の習得をし、現地企業でインターンシップをする。そしてその後ワーキングホリデーに切り替えるととても有意義な時間を過ごすことができるでしょう。</p> <br>
				<p>「帰国後の就職や転職に活かせる経験をしたい！」という経験重視派の方にもおすすめです。</p>
			</div>
		</div>
	</div>
	<div class="linkbox"><a href="/blog/osakablog/%e6%b5%b7%e5%a4%96%e3%81%8a%e5%bd%b9%e7%ab%8b%e3%81%a1%e6%83%85%e5%a0%b1/6541/"> カナダ インターンシッププログラム<br>（co-op）について詳しく知る</a>
	</div>

	<h3 id="plan_d" class="h3-01">ワーキングホリデーの経験を帰国後の就職に活かしたい！</h3>
	<div class="msg">
		<div class="msg-img"> <img class="lazyload" data-src="./images/person_d.webp" alt="person d"></div>
		<div class="msg-box">
			<div class="arrow">
				<div class="outer"></div>
				<div class="inner"></div>
	...
	<div class="msg">
		...
		<div class="msg-box">
			...
			<div class="message-body">
				<p>ワーキングホリデーの経験を帰国後の就職に活かしたいあなたには、学生ビザを使った長期留学がぴったりです。</p><br>
				<p>IELTS やケンブリッジ検定などの英語資格や、TESOL・TECSOL・J-shine と呼ばれる英語教授資格、バリスタの資格などは履歴書に書くことができるので、帰国後の就職活動で確実にご自身の武器となります。 </p> <br>
				<p>専門的な語学スキルや知識の習得は、帰国後の就職活動では大きく評価をされるポイントとなるので、積極的に挑戦してみてください。</p>
			</div>
		</div>
	</div>
	<div class="linkbox"><a href="/blog/fukuokablog/%E6%B5%B7%E5%A4%96%E3%81%8A%E5%BD%B9%E7%AB%8B%E3%81%A1%E6%83%85%E5%A0%B1/992/"> 海外で取得できる語学資格について <br>詳しく知る</a>
	</div>
	<div class="link-img text-center"><a href="/seminar/"><img class="lazyload" data-src="./images/banner_seminar.webp" alt="セミナーの検索・ご予約はこちらから"></a>
		<p class="text-center">▲ セミナーの検索・ご予約はこちらから ▲</p>
	</div>
	...
	<div class="support-block">
		<ul>
			<li>
				...
				<div class="body">
					<p>ワーキングホリデーや留学の情報収集ができる無料のセミナーを毎日開講しております。</p> <br>
	...
	<div class="link-img text-center pt-20 pb-20"><a href="/seminar/"><img class="lazyload" data-src="./images/banner_member.webp" alt=""></a>
	</div>
	<div class="top-move">
		<p><a href="#header">▲TOP に戻る</a></p>
	</div>

	<h2 id="st7" class="sec-title mb-15">その他のワーキングホリデーに関する情報</h2>
	...
	<div class="link-img text-center pt-20 pb-20"><a href="/ryugakusupport"><img class="lazyload" data-src="./images/banner_ryugaku.webp" alt=""></a>
	</div>
</div>
</div>
</div>

...
/* ========================= オーストラリアの学校 =================== */	
	...
	if ($p_id == 217) { // IH BRISBANE
		...
		$header_bg = '/wp-content/uploads/sites/2/2016/02/ihbne_sp.gif';
...
/* ========================= カナダの学校 =================== */	
	...
	if ($p_id == 2) { // 語学学校 オックスフォード　インターナショナル　ノースアメリカ (OI Vancouver・Toronto)

		$header_bg = 'wp-content/uploads/sites/3/2021/01/【SP】blog_header20210108_OLNA_02.png';
	...
	if ($p_id == 299) { // 語学学校 Vaiwest

		$header_bg = '/wp-content/uploads/sites/3/2016/03/vanwest_sp.gif';
...
if ($b_id == 5) { // United Kingdom Blog
	...
	$header_bg = 'wp-content/uploads/2015/01/europe_choice_sp.png'; // United Kingdom Top

...
!function($) {
	...
	var Datetimepicker = function(element, options) {
		...
		if (this.bootcssVer == 3) {
			if (this.pickTime) {
				template = DPGlobal.templateV3DT;
			} else {
				template = DPGlobal.templateV3D;
			}
		} else {
			template = DPGlobal.template;
		}
	...
	Datetimepicker.prototype = {
		...
		modifyDate : function(target, value) {
			var originalData = this.element.find('input').val();
			if (!originalData && target != 'date') {
				return true;
			}

			if (this.pickTime) {
				if ((!dateValidate(originalData.split(' ')[0]))
						|| !timeValidate(originalData.split(' ')[1])) {
					var formatted = DPGlobal.formatDate(new Date(),
							this.format, this.language, this.formatType);
					this.element.find('input').val(formatted);
					return false;
				}
				
				original_date = originalData.split('-');
				var year = original_date[0];
				var month = original_date[1];
				var day = original_date[2].split(' ')[0];
				original_time = originalData.split(':');
				var hour = original_time[0].split(' ')[1];
				var minute = original_time[1];
			} else {
				original_date = originalData.split('-');
				var year = original_date[0];
				var month = original_date[1];
				var day = original_date[2];
				if (!dateValidate(originalData.split(' ')[0])
						&& target != 'date') {
					var formatted = DPGlobal.formatDate(new Date(),
					this.format, this.language, this.formatType);
			...
			var target_minute = null;
			
			if (target != 'hour') {
				target_year = value.getFullYear();
				target_month = this.toDoubleDigits(value.getMonth() + 1);
				//if (this.pickTime) {
					//target_day = this.toDoubleDigits(value.getDate());
				//} else {
					target_day = ("0"+value.getUTCDate()).slice(-2);
				//}
				target_hour = this.toDoubleDigits(value.getHours() - 9); // consider
				// about
				// GMT->value
				target_minute = this.toDoubleDigits(value.getMinutes());
			} else {
				target_hour = value;
			}
			...
			if (this.pickTime) {
				switch (target) {
				case 'year':
					input_date = target_year + '-' + month + '-' + day + ' '
							+ hour + ':' + minute;
					break;

				case 'month':
					input_date = year + '-' + target_month + '-' + day + ' '
							+ hour + ':' + minute;
					break;

				case 'day':
					input_date = year + '-' + month + '-' + target_day + ' '
							+ hour + ':' + minute;
					break;
				...
				case 'minute':
					input_date = year + '-' + month + '-' + day + ' ' + hour
							+ ':' + target_minute;
					break;

				case 'date':
					input_date = target_year + '-' + target_month + '-'
							+ target_day;
					break;
				}
			} else {
			...
			this.element.find('input').val(input_date);
		},
		...
		place : function() {
			...
			if ($.browser.android || $.browser.iphone || $.browser.ipod
					|| $.browser.ipad || $.browser.ios || $.browser.tablet) {
			...
			if (this.formatViewType == "time") {
				...
				this.picker.find('.datetimepicker-hours thead th:eq(1)').text(
						hoursDisplay
								...
								+ minutesDisplay
								+ ' '
								+ (meridianDisplay ? meridianDisplay
										.toUpperCase() : ''));
				...
				this.picker.find('.datetimepicker-hours thead th:eq(1)').text(
						year + ' ' + dates[this.language].months[month] + ' '
								+ dayMonth + dates[this.language].suffix[0]);
				this.picker.find('.datetimepicker-minutes thead th:eq(1)')
						.text(
								year + ' ' + dates[this.language].months[month]
										+ ' ' + dayMonth
										+ dates[this.language].suffix[0]);
			}
		...
		click : function(e) {
			e.stopPropagation();
			e.preventDefault();
			var target = $(e.target).closest('span, td, th, legend, div');
			...
			if (target.length == 1) {
				...
				case 'span':
					if (!target.is('.disabled')) {
						...
						if (target.is('.month')) {
							...
							this.modifyDate('month', this.viewDate);
							...
							this.modifyDate('year', this.viewDate);
							...
							this.modifyDate('minute', this.viewDate);
						}
						if (this.viewMode != 0) {
				...
				case 'td':
					...
					this.modifyDate('day', this.viewDate);
					var oldViewMode = this.viewMode;
					this.showMode(-1);
					this.fill();
					if (oldViewMode == this.viewMode && this.autoclose) {
					...
					if (this.pickTime) {
						...
						this.modifyDate('date', this.viewDate);
						this.hide();
					}
					break;
				...
				case 'div':
					...
					if (target_class.match(/calendar-selected/)
							|| target_class.match(/calendar-editable/)) {
						var target_index = $(target).index();
						var current_index = $(target).parent().children(
								'[class*=current]').index();
						...
						if (current_index == -1) {
							...
							dir = current_index - target_index;
						}

						this.showMode(dir);

					} else if (target_class.match(/calendar-close/)) {
						this.hide();
					}
					break;
				}
	...
	DPGlobal.template = '<div class="datetimepicker">'
			...
			+ '</table>'
			+ '</div>' + '</div>';
	DPGlobal.templateV3DT = '<div class="datetimepicker">'
			+ '<div class="datetimepicker-minutes">'
			+ '<div class="col-xs-2 calendar-selected year">'+year+'</div>'
			+ '<div class="col-xs-2 calendar-selected month">'+month+'</div>'
			+ '<div class="col-xs-2 calendar-selected day">'+date+'</div>'
			+ '<div class="col-xs-2 calendar-selected hour">時</div>'
			+ '<div class="col-xs-2 calendar-current minute">分</div>'
			+ '<div class="col-xs-2 calendar-close"><span class="glyphicon glyphicon-remove"></span></div>'
			...
			+ '<div class="col-xs-2 calendar-selected month">'+month+'</div>'
			+ '<div class="col-xs-2 calendar-selected day">'+date+'</div>'
			+ '<div class="col-xs-2 calendar-current hour">時</div>'
			+ '<div class="col-xs-2 calendar-editable minute">分</div>'
			+ '<div class="col-xs-2 calendar-close"><span class="glyphicon glyphicon-remove"></span></div>'
			+ '<table class=" table-condensed col-md-12">'
			+ DPGlobal.headTemplateV3
			+ DPGlobal.contTemplate
			...
			+ '<div class="col-xs-2 calendar-selected year">'+year+'</div>'
			+ '<div class="col-xs-2 calendar-selected month">'+month+'</div>'
			+ '<div class="col-xs-2 calendar-current day">'+date+'</div>'
			+ '<div class="col-xs-2 calendar-editable hour">時</div>'
			+ '<div class="col-xs-2 calendar-editable minute">分</div>'
			+ '<div class="col-xs-2 calendar-close"><span class="glyphicon glyphicon-remove"></span></div>'
			+ '<table class=" table-condensed col-md-12">'
			+ DPGlobal.headTemplateV3
			...
			+ '<div class="datetimepicker-months">'
			+ '<div class="col-xs-2 calendar-selected year">'+year+'</div>'
			+ '<div class="col-xs-2 calendar-current month">'+month+'</div>'
			+ '<div class="col-xs-2 calendar-editable day">'+date+'</div>'
			+ '<div class="col-xs-2 calendar-editable hour">時</div>'
			+ '<div class="col-xs-2 calendar-editable minute">分</div>'
			+ '<div class="col-xs-2 calendar-close"><span class="glyphicon glyphicon-remove"></span></div>'
			+ '<table class="table-condensed col-md-12">'
			...
			+ '</div>'
			+ '<div class="datetimepicker-years">'
			+ '<div class="col-xs-2 calendar-current year">'+year+'</div>'
			+ '<div class="col-xs-2 calendar-editable month">'+month+'</div>'
			+ '<div class="col-xs-2 calendar-editable day">'+date+'</div>'
			+ '<div class="col-xs-2 calendar-editable hour">時</div>'
			+ '<div class="col-xs-2 calendar-editable minute">分</div>'
			+ '<div class="col-xs-2 calendar-close"><span class="glyphicon glyphicon-remove"></span></div>'
	...
	DPGlobal.templateV3D = '<div class="datetimepicker">'
			+ '<div class="datetimepicker-minutes">'
			+ '<div class="col-xs-3 calendar-selected year">'+year+'</div>'
			+ '<div class="col-xs-3 calendar-selected month">'+month+'</div>'
			+ '<div class="col-xs-3 calendar-selected day">'+date+'</div>'
			+ '<div class="col-xs-3 calendar-close"><span class="glyphicon glyphicon-remove"></span></div>'
			+ '<table class=" table-condensed col-md-12">'
			+ DPGlobal.headTemplateV3
			+ DPGlobal.contTemplate
			+ DPGlobal.footTemplate
			...
			+ '<div class="col-xs-3 calendar-selected year">'+year+'</div>'
			+ '<div class="col-xs-3 calendar-selected month">'+month+'</div>'
			+ '<div class="col-xs-3 calendar-current day">'+date+'</div>'
			+ '<div class="col-xs-3 calendar-close"><span class="glyphicon glyphicon-remove"></span></div>'
			+ '<table class=" table-condensed col-md-12">'
			+ DPGlobal.headTemplateV3
			+ '<tbody></tbody>'
			...
			+ '<div class="datetimepicker-months">'
			+ '<div class="col-xs-3 calendar-selected year">'+year+'</div>'
			+ '<div class="col-xs-3 calendar-current month">'+month+'</div>'
			+ '<div class="col-xs-3 calendar-editable day">'+date+'</div>'
			+ '<div class="col-xs-3 calendar-close"><span class="glyphicon glyphicon-remove"></span></div>'
			+ '<table class="table-condensed col-md-12">'
			+ DPGlobal.headTemplateV3
			+ DPGlobal.contTemplate
			...
			+ '</div>'
			+ '<div class="datetimepicker-years">'
			+ '<div class="col-xs-3 calendar-current year">'+year+'</div>'
			+ '<div class="col-xs-3 calendar-editable month">'+month+'</div>'
			+ '<div class="col-xs-3 calendar-editable day">'+date+'</div>'
			+ '<div class="col-xs-3 calendar-close"><span class="glyphicon glyphicon-remove"></span></div>'
			+ '<table class="table-condensed col-md-12">'
			+ DPGlobal.headTemplateV3

...
!function($) {
	...
	DPGlobal.templateV3DT = '<div class="datetimepicker">'
			+ '<div class="datetimepicker-minutes">'
			+ '<div class="col-xs-2 calendar-selected year">年</div>'
			+ '<div class="col-xs-2 calendar-selected month">月</div>'
			+ '<div class="col-xs-2 calendar-selected day">日</div>'
			...
			+ '<div class="col-xs-2 calendar-selected year">年</div>'
			+ '<div class="col-xs-2 calendar-selected month">月</div>'
			+ '<div class="col-xs-2 calendar-current day">日</div>'
			...
			+ '<div class="datetimepicker-months">'
			+ '<div class="col-xs-2 calendar-selected year">年</div>'
			+ '<div class="col-xs-2 calendar-current month">月</div>'
			+ '<div class="col-xs-2 calendar-editable day">日</div>'
			+ '<div class="col-xs-2 calendar-editable hour">時</div>'
			+ '<div class="col-xs-2 calendar-editable minute">分</div>'
			+ '<div class="col-xs-2 calendar-close"><span class="glyphicon glyphicon-remove"></span></div>'
			+ '<table class="table-condensed col-md-12">'
			...
			+ '</div>'
			+ '<div class="datetimepicker-years">'
			+ '<div class="col-xs-2 calendar-current year">年</div>'
			+ '<div class="col-xs-2 calendar-editable month">月</div>'
			+ '<div class="col-xs-2 calendar-editable day">日</div>'
			+ '<div class="col-xs-2 calendar-editable hour">時</div>'
			+ '<div class="col-xs-2 calendar-editable minute">分</div>'
			+ '<div class="col-xs-2 calendar-close"><span class="glyphicon glyphicon-remove"></span></div>'
	...
	DPGlobal.templateV3D = '<div class="datetimepicker">'
			+ '<div class="datetimepicker-minutes">'
			+ '<div class="col-xs-3 calendar-selected year">年</div>'
			+ '<div class="col-xs-3 calendar-selected month">月</div>'
			+ '<div class="col-xs-3 calendar-selected day">日</div>'
			...
			+ '<div class="col-xs-3 calendar-selected year">年</div>'
			+ '<div class="col-xs-3 calendar-selected month">月</div>'
			+ '<div class="col-xs-3 calendar-current day">日</div>'
			+ '<div class="col-xs-3 calendar-close"><span class="glyphicon glyphicon-remove"></span></div>'
			+ '<table class=" table-condensed col-md-12">'
			+ DPGlobal.headTemplateV3
			+ '<tbody></tbody>'
			...
			+ '<div class="datetimepicker-months">'
			+ '<div class="col-xs-3 calendar-selected year">年</div>'
			+ '<div class="col-xs-3 calendar-current month">月</div>'
			+ '<div class="col-xs-3 calendar-editable day">日</div>'
			+ '<div class="col-xs-3 calendar-close"><span class="glyphicon glyphicon-remove"></span></div>'
			+ '<table class="table-condensed col-md-12">'
			+ DPGlobal.headTemplateV3
			+ DPGlobal.contTemplate
			...
			+ '</div>'
			+ '<div class="datetimepicker-years">'
			+ '<div class="col-xs-3 calendar-current year">年</div>'
			+ '<div class="col-xs-3 calendar-editable month">月</div>'
			+ '<div class="col-xs-3 calendar-editable day">日</div>'
			+ '<div class="col-xs-3 calendar-close"><span class="glyphicon glyphicon-remove"></span></div>'
			+ '<table class="table-condensed col-md-12">'
			+ DPGlobal.headTemplateV3

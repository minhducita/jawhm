            ...
            <div class="list-group col-md-8">
                ...
                <span id="collapse_1" class="panel-collapse collapse in">
                    <ul class="list-group" style="margin-bottom: 0;">
                        <li class="list-group-item">出発日: <span style="padding-left: 24px;">{$plan.scheduled_departure_date|date_format:"%G年%m月%d日"}</span></li>
                        <li class="list-group-item">到着日: <span style="padding-left: 24px;">{$plan.scheduled_arrival_date|date_format:"%G年%m月%d日"}</span></li>
                        <li class="list-group-item">入学日: <span style="padding-left: 24px;">{if $plan.scheduled_enroll_date}{$plan.scheduled_enroll_date|date_format:"%G年%m月%d日"}{else}入学予定なし{/if}</span></li>
                    </ul>
                </span>
            </div>
        </div>
{/if}
        ...
        <div class="col-xs-12 col-md-4" {if $smp==1}style="margin-top: 40px;"{/if}>
            <div class="list-group">
                <h4 class="panel-title"><a {if $smp == 1} data-toggle="collapse" data-parent="#accordion" href="#collapse_1" id="accordion_1" {/if} class="list-group-item active">次のステップ{if $smp == 1}<i class="pull-right glyphicon glyphicon-chevron-up"></i>{/if}</a></h4>
                <span id="collapse_1" class="panel-collapse collapse in">
                    <ul class="list-group" style="margin-bottom: 0;">
                        {if $survey == 1}
                        ...
                        {else}
                            ...
                            <li class="list-group-item">
                                ...
                                {if $reserve.0 != '' and $reserve.0|date_format:"%G年%m月%d日 %H:%M" >= $smarty.now|date_format:"%G年%m月%d日 %H:%M"}
            ...
            <div class="col-xs-12 col-md-4">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body" style="margin-bottom: 30px;">
                        <div class="col-xs-4">
                            <span onClick="location.href='plan/index'" class="button-step clickable {if $plan.progress_level >= 2}success-color{else}danger-color{/if}" abbr="android0-divine">準備</span><span class="button-triangle" onClick="location.href='plan/index'" id="android0"></span>
                        </div>
                        <div class="col-xs-4">
                    ...
                    <div class="col-xs-12 kill-grid">
                        ...
                        <div class="col-xs-5" style="left: 10px;">
                            {if $plan.progress_level == 2}<img src="themes/images/imakoko.png" alt="いまここ" class="imakoko" style="margin-left: 20px;"><img src="themes/images/bumkun/blue/top/1.png" alt="ばむくん" id="bum_click2" class="menu-bum" style="Z-index: 1; margin-top: -36px; margin-left: 10px; ">{/if}
                        </div>
                        <div class="col-xs-2">
...
{if $smp == 1}
        <div class="col-xs-12 col-md-4">
            <div class="list-group">
                <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapse_2" class="list-group-item active" id="accordion_2">渡航計画(目標){if $smp == 1}<i class="pull-right glyphicon glyphicon-chevron-down"></i>{/if}</a></h4>
        ...
        <div class="col-xs-12 col-md-4">
            <div class="list-group">
                ...
                <span id="collapse_3" class="panel-collapse collapse {if $smp == 0}in{/if}">
                    ...
                    <a href="member/index" class="list-group-item">会員情報変更 <span class="text-notice">会員番号: {$mem_id}</span></a>
                    {*<a href="talk/index" class="list-group-item">一言相談</a>*}
...
{if $smp == 0}<a id="help-index" class="pull-right"><i class="glyphicon glyphicon-question-sign"></i>ヘルプ</a>{/if}
        </div>

...
<div class="contents-wrapper">
    <h2>ワーホリセミナー</h2>
    {if $status === 'live'}<a id="ust_online"><img src="{$base}/mypage/themes/images/onair.png" alt="放送中"></a>{else}<img src="{$base}/mypage/themes/images/offair.png" alt="オフライン">{/if}<br />
    {if $status === 'live'}<a id="ust_camera">{/if}<img src="https://www.jawhm.or.jp/css/images/camera.png" alt="カメラ">{if $status === 'live'}</a>{/if}
</div>

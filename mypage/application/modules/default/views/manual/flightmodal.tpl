...
<br />
<img class="manual-img" src="data:image/png;base64, {$img1}"><br />
<br />
以下フライト入力情報の分割画像になります。
<br />
<img class="manual-img" src="data:image/png;base64, {$img2}"><br />
<br />
<br />
<img class="manual-img" src="data:image/png;base64, {$img3}"><br />
<span class="help-block">"出発地・到着地はサジェストされるので入力雨が楽です。</span>
<br />
<br />
<img class="manual-img" src="data:image/png;base64, {$img4}"><br />
<br />
すべての入力項目を埋めて、送信ボタンを押すと、フライト情報が登録されます。<br />
<br />
<img class="manual-img" src="data:image/png;base64, {$img5}"><br />
<br />
次のステップとして、入力した情報をカウンセラーがチェックできるように航空券を携帯のカメラなどで撮影した画像をアップロードをお願いします。<br />
下の矢印の通り、編集ボタンをクリックします。
<br />
<img class="manual-img" src="data:image/png;base64, {$img6}"><br />
<br />
画面最下部に編集のみ出現する画像アップロードボタンをクリックしてください。<br />
<br />
<img class="manual-img" src="data:image/png;base64, {$img7}"><br />
<br />
すると、以下のような画面がポップアップします。<br />
<br />
<img class="manual-img" src="data:image/png;base64, {$img8}"><br />
<br />
...
<br />
<img class="manual-img" src="data:image/png;base64, {$img9}"><br />
</div>
</div>

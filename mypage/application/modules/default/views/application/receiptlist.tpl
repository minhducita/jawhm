                ...
                <tbody>
                    {foreach item=item from=$items}
                        <tr>
                            ...
                            <td class="text-center"><a href="application/getfile?file_no=1&branch_no={$item.branch_no}" target="_blank"><span class="glyphicon glyphicon-list-alt clickable"></span></a></td>
                        </tr>
                     {$i = $i + 1}
                {/foreach}
                </tbody>

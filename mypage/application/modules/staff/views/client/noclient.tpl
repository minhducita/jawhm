...
<head class="login">
  ...
  <link rel="stylesheet" type="text/css" href="{$base}/mypage/themes/css/staff.css" media="all" /> 
...
<body>
	<h1>お客様情報がありません</h1>
	申し訳ありませんが、再度スタッフメニューよりログインをお願いします。
...
<script type="text/javascript" src="{$base}/mypage/themes/js/staff.js"></script>
</body>
</html>
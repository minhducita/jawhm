    ...
    {foreach item=item from=$items}
        <div class="comment-wrapper">
            ...
            <div class="comment client-comment">
                ...
                <span id="changetalk_{$item.talk_id}" class="glyphicon glyphicon-edit clickable" style="margin-right: 10px;"> </span><span id="deltalk_{$item.talk_id}_{$item.commented_date}" class="glyphicon glyphicon-trash"></span></span>
            </div>
            {if $item.ans_flag == 1}

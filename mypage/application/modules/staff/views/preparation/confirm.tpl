        ...
        <form id="confirm-edit" method="post">
            <fieldset>
                ...
                <div class="form-group col-xs-12">
                    ...
                    <div class="col-xs-8">
                        <button id="{$name}-confirm-preparation" class="btn btn-success">確認済</button>
                        <button id="{$name}-redo-preparation" class="btn btn-danger">やり直し</button>
                        <button id="{$name}-back-preparation" class="btn btn-warning">確認待ち</button>
                    </div>
                </div>

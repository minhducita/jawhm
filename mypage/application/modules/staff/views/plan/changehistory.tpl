        ...
        <form id="nextstep-edit" method="post">
            <fieldset>
                <div class="form-group">
                    ...
                    <div class="col-sm-8 combo_wrapper">
                        ...
                        <select id="combo_select" class="form-control input-block-level combo_select" name="step_name_select">
                            <option>手動入力</option>
                            {foreach item=step from=$next_step}
                                <option {if $item.step_name === $step.step_name}selected{/if}>{$step.step_name}</option>
                            {/foreach}
                        </select>
                        <div class="combo_div">
                            <input class="input-block-level combo_text form-control input-group" type="text" name="step_name" value="{$item.step_name}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input class="form-control" type="text" name="step_exposition_short" value="{$item.step_exposition_short}">
                    </div>
                </div>
                ...
                <div class="form-group">
                       ...
                       <div class="col-sm-8">
                         <input class="form-control" type="text" name="preparation" value="{$item.preparation}">
                    </div>
                </div>
                ...
                <input type="hidden" name="action_tag" value="next_step">
            </fieldset>
        </form>
    </div>

    <div class="modal-footer">
        <button id="nextstep_staff" type="button" class="btn btn-primary">送信</button>

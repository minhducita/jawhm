<div class="modal-content window-container">
    ...
    <div class="modal-body">
        <form id="contact-edit-client" method="post">
            <fieldset>
                ...
                <input type="hidden" name="action_tag" value="client_contact">
            </fieldset>
        </form>
    </div>

    <div class="modal-footer">
        <button id="contact_edit_client" type="button" class="btn btn-primary">{$msg[3].message}</button>

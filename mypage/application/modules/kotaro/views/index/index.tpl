                        ...
                        <div class="col-xs-12">
                            {if isset($img[0])}
                                <div class="{if $iphone==0}col-xs-4{else}col-xs-6{/if}">
                                    <a href="{$base}/mypage/data/survey/{$load_data.image_id1}" target="_blank"><img src="{$img[0]}" alt="file"></a><br />
                                </div>
                            {/if}
                            {if isset($img[1])}
                                <div class="{if $iphone==0}col-xs-4{else}col-xs-6{/if}">
                                    <a href="{$base}/mypage/data/survey//{$load_data.image_id1}" target="_blank"><img src="{$img[1]}" alt="file"></a><br />
                                </div>
                            {/if}
                            {if isset($img[2])}
                                <div class="{if $iphone==0}col-xs-4{else}col-xs-6{/if}">
                                    <a href="{$base}/mypage/data/survey//{$load_data.image_id1}" target="_blank"><img src="{$img[2]}" alt="file"></a><br />
                                </div>
                            {/if}
                        </div>
                    </div>
                </li>
                <li class="list-group-item col-xs-12 list-title-centering" style="margin-bottom:30px;">
...
<div>
    <nav class="navbar navbar-default navbar-fixed-bottom" role="navigation">
        <div class="container">
            <a href="kotaro/index/logout" class="btn btn-default">ログアウトする</a>
        </div>
    </nav>
</div>

<?php /* Smarty version Smarty-3.1.13, created on 2015-05-28 13:22:06
         compiled from "/var/www/html/mypage/application/modules/staff/views/application/confirm.tpl" */ ?>
<?php /*%%SmartyHeaderCode:908719381556697eeac26a3-32282689%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cfaa602833963a0f1ed851a4ec1551dafcad5b50' => 
    array (
      0 => '/var/www/html/mypage/application/modules/staff/views/application/confirm.tpl',
      1 => 1419238970,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '908719381556697eeac26a3-32282689',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_556697eebdb674_75242607',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_556697eebdb674_75242607')) {function content_556697eebdb674_75242607($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/html/mypage/library/Smarty/plugins/modifier.date_format.php';
...
-confirm" class="btn btn-success">確認済</button>
                        <button id="<?php echo htmlspecialchars(htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'UTF-8', true), ENT_QUOTES, 'UTF-8');?>
-redo" class="btn btn-danger">やり直し</button>
                        <button id="<?php echo htmlspecialchars(htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'UTF-8', true), ENT_QUOTES, 'UTF-8');?>
-back" class="btn btn-warning">確認待ち</button>
                    </div>
                </div>

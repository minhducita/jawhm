...
//ini_set( "display_errors", "On");
	...
	{
		try {
			$ini = parse_ini_file('../../bin/member.ini', FALSE);
...
$header_obj->title_page='ワーホリ・留学、オーストラリアセミナー';

$header_obj->description_page='ワーホリの渡航先として一番人気のオーストラリア。日本ワーキング・ホリデー協会では、そんなオーストラリアに関するセミナーを随時開催しています。少しでも興味のある方は、是非参加してみてください。';

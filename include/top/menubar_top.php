...
?>
    ...
    { ?>
            <table style="width:100%;">
                <tr>
                    <td><div id="btn-register"><a href="https://member.jawhm.or.jp/mem2/register.php" title="メンバー登録はこちら">メンバー登録はこちら</a></div></td>
...
?>
	...
	/*
			...
			<ul class="g-n-main01">
                <li class="lh_top0">
					<a href="http://www.jawhm.or.jp/ad/www/delivery/ck.php?oaparams=2__bannerid=139__zoneid=122__cb=d919cfaf9b__oadest=http%3A%2F%2Fmember.jawhm.or.jp%2Fmem2%2Fregister.php" target="_blank">
			...
			<?php // stop source ad 
				...
				$list_menu = file_get_contents("http://".$_SERVER['SERVER_NAME']."/memberpage/api/menu.php?locationMenu=menu-left", false, stream_context_create($arrContextOptions));

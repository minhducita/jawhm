...
//		public $fncMenubar_advertisement = array(122,123,124,125,30,31); 	// advertisement to display
        ...
        public $fncMenubar_advertisement = array(122,1,2,3,123,124,125,31); 	// advertisement to display
        ...
        public function display_header()
        {
            ...
            /* ↓↓↓ 20140912追加 ↓↓↓ */
            require_once (PATH.'include/top/menubar_top.php');
...
<link href="/css/top/new_contents.css" rel="stylesheet" type="text/css" />';
            //display css files
...
<body'.$body_onload.'>
            ...
            if($this->no_standard_template === false)
            {
                ...
                /* ↓↓↓ 20140912修正 ↓↓↓ */
                    ...
                    if(!empty($_SESSION['mem_id']) && $_SESSION['mem_name'] != '' && $_SESSION['mem_level'] != -1) {
//                        echo'<div id="btn-logout"><input type="button" value="ログアウト" onClick="fnc_logout();"></div>';
                    ...
                    /*echo'				<form name="change_view" method="POST" action="">
                                ...
                                <div id="header-box-new">aa
                                    <a href="/"><h1 id="header-new">'.$this->fncMenuHead_h1text.'</h1></a>
                                </div>
                        ';*/

                    echo'</div>
                        <div id="header-box-new">
                            <h1 id="header" class="header-new"><a href="/"><img src="/images/mobile/mobile-new-header.gif" class="responsive-img"></a></h1>
        ...
        public function breadcrumbs($parent='',$parents_children='')
        {
            ...
            else
            {
                if (($this->computer_use() === false && $_SESSION['pc'] != 'on' && $this->pcmobile_type === false)|| $this->debug_mobile_page)
                {
                    ...
                    $texthome = '<a href="/">ワーキングホリデー（ワーホリ協会）</a>';
                }
				/*get url */

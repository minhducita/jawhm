...
<?php if( strpos($_SERVER['REQUEST_URI'], "member") == true || strpos($_SERVER['REQUEST_URI'], "footer_mobile") == true ){ //@minhquyen $_SERVER['REQUEST_URI'], "footer_mobile" to hiden EMAIL FORM when be include by memberpage WP source 
} else { ?>


<link rel="stylesheet" type="text/css" media="screen" href="/sp/css/mailbox.css?v=20180725">
<!-- <div id="email_regis_2607">
	<form action="" method="POST">
		...
		<div class="er-b1">
			<input type="email" name="email" placeholder="メールアドレスを入力してね">
...
<?php }; ?>
		<!-- ↓↓↓ 20140912追加 ↓↓↓ -->
            <div id="footer-mobile-new">
				...
				<dt><a style="color: unset" target="_blank" href="/wh/australia/"><span>オーストラリアのワーキングホリデーについて</span></a></dt>
					...
					<dd>
						<ul>
							...
							<li><a href="/country/poland">ポーランド</a></li>
							<li><a href="/visa/v-pol.html">ポーランドビザ情報</a></li>
							<li><a href="/country/portugal">ポルトガル</a></li>
							<li><a href="/visa/v-prt.html">ポルトガルビザ情報</a></li>
							<li><a href="/country/norway">ノルウェー</a></li>
					...
					<dd>
						<ul>
							...
							<li><a href="/interview/">協会のカウンセラー紹介</a></li>
					...
					<dd>
						<ul>
							<li><a href="/ryugakusupport/">留学サポートサービス</a></li>
...
-->
							...
							<li><a href="/party/">ワーホリ交流会（パーティー）</a></li>
                    ...
                    <a href="http://www.job-board.info" style="text-decoration: none;" rel="noreferrer"><dt><span>Job Board(求人掲示板)</span></dt></a>
					...
					<dt><span><a href="/hoken.html" style="text-decoration:none;">保険のご案内（留学・ワーホリ）</a></span></dt>
					...
					<dd>
						<ul>
							...
							<li><a href="/office/kumamoto/">熊本オフィス</a></li>
						</ul>
					</dd>
				</dl>
				...
				<div id="mobile-globalmenu-list" class="monav-wrapper" style="display: none;"> 
					<?php
						if(!empty($_SESSION['mem_id']) && !empty($_SESSION['mem_name']) && @$_SESSION['mem_level'] != -1) {
							...
							echo '<a target="_self" class="mobile_membertop" href="/member/logout.php"> 　ログアウト　</a>';
						} else {
							echo '<a href="/member/"><i class="fa fa-key"></i>メンバーログイン</a>';
						}
					?>
					
					<ul>
						<li class="here"><a href="/seminar/ser/"><i class="fa fa-pencil"></i><span>ワーホリ＆留学無料セミナー</span></a></li>
						<li><a href="/office/"><i class="fa fa-book"></i><span>アクセス</span></a></li>
						<li><a href="/qa.html"><i class="fa fa-comments"></i><span>よくある質問</span></a></li>
						<li><a href="/blog/"><i class="fa fa-building"></i><span>ワーホリブログ</span></a></li>
						<li><a href="/katsuyou.html"><i class="fa fa-suitcase"></i><span>ワーホリ協会で</br>できること</span></a></li>
						<li><a href="/country/"><i class="fa fa-globe"></i><span>ワーホリ協定国</span></a></li>
						<li><a href="/start.html"><i class="fa fa-plane"></i><span>はじめての</br>ワーホリ</span></a></li>
						<li><a href="https://member.jawhm.or.jp/mobileform/member_form.php" rel="noreferrer"><span>メンバー登録</span><em>JAWHM</em></a></li>
					</ul>
				</div>
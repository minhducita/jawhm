...
<div align="center"><img  src="images/topimage.jpg" / id="top"></div> 
<!--　 <div align="center">
	<div align="left"  style="width:800px;line-height:1" ><Font Size="2">　本年、オーストラリアとの協定から始まったワーキングホリデー制度が30周年を迎え、
    ...
    <tr>
      ...
      <td width="800" height="100" background="images/back.gif" style="padding: 10px 20px 15px 20px;">
		<table>
			<tr>
			<td>
				　<Font Size="4"><b>秋の留学＆ワーキング・ホリデーフェア2011は終了致しました。</b></font>
					<HR size="1" color="#000000" style="border-style:dotted" width="800px;">
			<Font Size="2">　秋の留学＆ワーキング・ホリデーフェア 2011は10月22日をもちまして終了致しました。<br/>
			　全国各地からたくさんのご参加本当にありがとうございました。<br/>
			　<a href="http://www.jawhm.or.jp/seminar.html"><b>通常無料セミナーはこちら（東京・大阪・福岡）</b></a><br/>
<br/>
			　<b>＜＜参加者の声＞＞</b><br/>
<br/>
...
<br/>
<div align="right">…などなど様々なご感想を頂きました！次回開催をお楽しみに！</div>
				</font>
			</td>
			</tr>
		</table>
    ...
    <tr>
      ...
      <td width="800" height="100" background="images/back.gif" style="padding: 15px 20px 15px 20px;">
		...
		<table>
			...
			<Font Size="2">
				　現地の学校スタッフから直接お話を聞くことができます。<br />
				今回ワーキングホリデー協定各国からたくさんの語学学校がフェアに参加します！<br />
				自分に合った学校を探しましょう。</font><br />
...
<div style="text-align:right;"><A Href="#top"><font size=2>▲　トップにもどる</font></A></div><br />

<div class="modal-content window-container">
	<div class="modal-header">
	    ...
	    <h4 class="modal-title">仮登録メールアドレス再送</h4>
	</div>
		
	<div class="modal-body">
	    <form id="resend-email" method="post">
	        <fieldset>
				<div class="form-group">
                    <label for="email" class="col-sm-4 control-label">メールアドレス</label>
                    <div class="col-sm-8">
                    	<input id="text" class="form-control" type="email" name="resend_email" size="20" autofocus >
                    	<div id="suggest"></div>
					</div>
				</div>
	...
	<div class="modal-footer">
		<button id="email_resend" type="button" class="btn btn-primary">送信</button>

                    ...
                    <form id="payment" method="POST" action="https://www.paydesign.jp/settle/settle3/credit/settle_cr_cpt25.do">
                        ...
                        <table class="payment-process">
                            ...
                            <tr>
                                ...
                                <td><input type="number" name="CARDNO" size="20" maxlength="16" class="focus" /><br/><small><strong>ハイフンは入力しないでください。</strong></small><br/><small style="color:#999999;display:block;width:10px;padding-left:50px;">例）9876543210123456</small></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input type="number" name="csc" size="5" maxlength="3" class="focus" /><br/><small><strong>カード裏面の番号の下３桁を入力してください。</strong></small><br/><small style="color:#999999;display:block;width:10px;padding-left:50px;">例）123</small></td>
                            </tr>
                            </table>

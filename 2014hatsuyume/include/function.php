...
if ($placename_in_japanese == '東京')	{
	$selected_day = 15;
	$limit_date['half_month'] = false;
}

$limit_date['beginning_date_yy'] = 2014;
$limit_date['beginning_date_mm'] = 1;
$limit_date['ending_date_yy'] = 2014;
$limit_date['ending_date_mm'] = 1;

//$limit_date['date_limit_beginning'] = 6;;
$year = 2014;
$month = 1;


$limit_date['day'] = 6;
$limit_date['last_day_to_search'] = 25;

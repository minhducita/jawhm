...
<h2 class="sec-title">ワーホリ・留学の無料セミナーのご案内</h2>
            ...
            <div style="padding-left:20px; float:left; margin-bottom: 10px; width:100%;" >
				<div style="padding-bottom:10px; margin-top:10px;">
					<p>
					「今年こそ海外に行きたい！」でも何から準備すればいいのか分からない。<br/>
					どんな留学プランが自分に一番合っているのか、知りたい方は初夢フェアのセミナーにお越し下さい。<br/>
					海外のプロである当協会留学カウンセラー、海外語学学校スタッフが皆さまのプラン作成のお手伝いをいたします。<br/>
					</p>	
				</div>
			</div>
			
			<div style="padding-left:20px; float:left; margin-bottom: 20px; width:100%;" >
				<div style="border: 2px dotted #cccccc; margin-bottom: 15px; padding: 20px 20px 20px 20px; width: 90%; background-image : url(images/seminar.jpg);background-repeat : no-repeat; background-position : 96%">
					...
					<img src="images/s-seminar-yoyaku.png" style="width: 70%; margin-top: 10px;">
				</div>
			</div>
			
<h2 class="sec-title">初夢フェア活用ガイド</h2>
			
			<center><img src="images/copy.png"></center>
	
			<div style="float: left; width: 269px; margin-left: 10px; border: 2px dotted #cccccc; padding: 20px 10px 0px 10px;">

				<img src="images/taiken.png" style="margin-bottom: 5px;"><br/>
				<center><img src="images/taiken.jpg" ></center><br/>
			
				<p>
					経験者だから話せる、ビザについて、現地でのお仕事・住まい、語学学校、実際の予算、渡航までの準備…。
					少人数制でアットホームな雰囲気もこのセミナーの特徴です。
					体験談を交えながら皆さまのプラン作成のお手伝いをします。
				</p>
				
				<div align="right">
					<img src="images/seminar_off.png" style="margin-top: 10px;">
				</div><br/>
				<clear="both"/>
			</div>	
			...
			<div style="float: left; width: 269px; margin-left: 10px; border: 2px dotted #cccccc; padding: 20px 10px 0px 10px;" >
				...
				<div align="right"><img src="images/seminar_off.png" style="margin-top: 10px;"></div><br/>
				<clear="both"/>
			</div>
		

		
		<div style="float: right; width: 269px; margin-bottom: 10px; border: 2px dotted #cccccc; padding: 20px 10px 0px 10px;">

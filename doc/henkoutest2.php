...
function renderDates(){
	...
	//hide school specific dates
	let x = getSchoolClass()
	$(x).css("visibility","hidden");
	//hide date specific dates
	switch(t){
		case '202112':
			$(".y2022.m1").parent().css("visibility","hidden");
		case '202111':
			$(".y2021.m12").parent().css("visibility","hidden");
		case '202110':
			$(".y2021.m11").parent().css("visibility","hidden");
		case '20219':
			$(".y2021.m10").parent().css("visibility","hidden");
		case '20218':
			$(".y2021.m9").parent().css("visibility","hidden");
		case '20217':
			$(".y2021.m8").parent().css("visibility","hidden");
		case '20216':
			$(".y2021.m7").parent().css("visibility","hidden");
		case '20215':
			$(".y2021.m6").parent().css("visibility","hidden");
		case '20214':
			$(".y2021.m5").parent().css("visibility","hidden");
		case '20213':
			$(".y2021.m4").parent().css("visibility","hidden");
		case '20212':
			$(".y2021.m3").parent().css("visibility","hidden");
		case '20211':
			$(".y2021.m2").parent().css("visibility","hidden");
		case '202012':
			$(".y2021.m1").parent().css("visibility","hidden");
		case '202011':
			$(".y2020.m12").parent().css("visibility","hidden");
		case '202010':
			$(".y2020.m11").parent().css("visibility","hidden");
		case '20209':
			$(".y2020.m10").parent().css("visibility","hidden");
		case '20208':
			$(".y2020.m9").parent().css("visibility","hidden");
		case '20207':
			$(".y2020.m8").parent().css("visibility","hidden");
		case '20206':
			$(".y2020.m7").parent().css("visibility","hidden");
		case '20205':
			$(".y2020.m6").parent().css("visibility","hidden");
		case '20204':
			$(".y2020.m5").parent().css("visibility","hidden");
		case '20203':
			$(".y2020.m4").parent().css("visibility","hidden");
		case '20202':
			$(".y2020.m3").parent().css("visibility","hidden");
		case '20201':
			$(".y2020.m2").parent().css("visibility","hidden");
	}
	// if(m>=4) {m1		$(".m10").parent().css("visibility","hidden");
	// 	$(".m11").parent().css("visibility","hidden");
	// 	$(".m12").parent().css("visibility","hidden");
	// }
	// if (m==12) {
...
<form name="form1" method="post" action="./henkou2.php" onSubmit="return fncCheck();">
	...
	<tr>
		...
		<td style="padding:8px 10px 8px 10px;">
			...
			<input id="year" type="text" name="出発予定年" value="" style="display: none;">
			<input type="radio" name="変更解約内容" value="入学日変更" style="display: none;" checked>
			<input type="radio" name="出発予定月" class="yoteituki" onchange="changeYotei('2020')" value="4" required="">&nbsp;4月&nbsp;&nbsp;
			<input type="radio" name="出発予定月" class="yoteituki" onchange="changeYotei('2020')" value="5" required="">&nbsp;5月&nbsp;&nbsp;
			<input type="radio" name="出発予定月" class="yoteituki" onchange="changeYotei('2020')" value="6" required="">&nbsp;6月&nbsp;&nbsp;
			<input type="radio" name="出発予定月" class="yoteituki" onchange="changeYotei('2020')" value="7" required="">&nbsp;7月&nbsp;&nbsp;
			<input type="radio" name="出発予定月" class="yoteituki" onchange="changeYotei('2020')" value="8" required="">&nbsp;8月&nbsp;&nbsp;<br>
			<input type="radio" name="出発予定月" class="yoteituki" onchange="changeYotei('2020')" value="9" required="">&nbsp;9月&nbsp;&nbsp;
			<input type="radio" name="出発予定月" class="yoteituki" onchange="changeYotei('2020')" value="10" required="">&nbsp;10月&nbsp;&nbsp;
			<input type="radio" name="出発予定月" class="yoteituki" onchange="changeYotei('2020')" value="11" required="">&nbsp;11月&nbsp;&nbsp;
			<input type="radio" name="出発予定月" class="yoteituki" onchange="changeYotei('2020')" value="12" required="">&nbsp;12月
			&nbsp;<hr/>
			<label>2021年</label><br>
			<input type="radio" name="出発予定月" class="yoteituki" onchange="changeYotei('2021')" value="1" required="">&nbsp;1月&nbsp;&nbsp;
			<input type="radio" name="出発予定月" class="yoteituki" onchange="changeYotei('2021')" value="2" required="">&nbsp;2月&nbsp;&nbsp;
			<input type="radio" name="出発予定月" class="yoteituki" onchange="changeYotei('2021')" value="3" required="">&nbsp;3月&nbsp;&nbsp;
			<input type="radio" name="出発予定月" class="yoteituki" onchange="changeYotei('2021')" value="4" required="">&nbsp;4月&nbsp;&nbsp;
			<input type="radio" name="出発予定月" class="yoteituki" onchange="changeYotei('2021')" value="5" required="">&nbsp;5月&nbsp;&nbsp;
			<input type="radio" name="出発予定月" class="yoteituki" onchange="changeYotei('2021')" value="6" required="">&nbsp;6月&nbsp;<br>
			<input type="radio" name="出発予定月" class="yoteituki" onchange="changeYotei('2021')" value="7" required="">&nbsp;7月&nbsp;&nbsp;
			<input type="radio" name="出発予定月" class="yoteituki" onchange="changeYotei('2021')" value="8" required="">&nbsp;8月&nbsp;&nbsp;
			<input type="radio" name="出発予定月" class="yoteituki" onchange="changeYotei('2021')" value="9" required="">&nbsp;9月&nbsp;&nbsp;
			<input type="radio" name="出発予定月" class="yoteituki" onchange="changeYotei('2021')" value="10" required="">&nbsp;10月&nbsp;&nbsp;
			<input type="radio" name="出発予定月" class="yoteituki" onchange="changeYotei('2021')" value="11" required="">&nbsp;11月&nbsp;&nbsp;
			<input type="radio" name="出発予定月" class="yoteituki" onchange="changeYotei('2021')" value="12" required="">&nbsp;12月
			&nbsp;<br/>
		</td>
	</tr>
	<tr>
...
<!-- 			<label class="no-ilsc no-ihbri no-umc no-els no-sgic no-aus-ec no-nz-ec no-nzlc" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m7 y2020 school-date"
			...
			<label class="no-ilsc no-ihbri no-umc no-els no-sgic" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m8 y2020 school-date"
			...
			<label class="no-aus-ec no-ihbri no-ilac no-els no-sgic no-nz-ec" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m9 y2020 school-date"
			...
			<br/>
 			<label class="no-aus-ec no-ihbri no-ilac no-els no-sgic no-nzlc no-nz-ec" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m10 y2020 school-date"
			...
			<label class=" no-ilac no-els no-sgic no-nzlc no-aus-ec no-nz-ec" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m11 y2020 school-date"
			...
			<label class="no-umc no-ilsc no-ihbri no-nz-ec no-wwse" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m12 y2020 school-date"
...
<!-- 			<label class="no-cce no-ihbri no-ihvan no-els no-bloom no-umc" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m1 y2021 school-date"
				name="入学日変更・変更後" value="2021/1/4" required="">1月4日&nbsp;
			</label>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-ilac no-sgic no-ilsc no-kaplan" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m1 y2021 school-date"
				name="入学日変更・変更後" value="2021/1/11" required="">1月11日&nbsp;
			</label>
			<label class="no-cce no-ihbri no-nzlc no-ihvan no-els no-bloom no-sgic no-umc no-ilsc no-kaplan" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m1 y2021 school-date"
				name="入学日変更・変更後" value="2021/1/18" required="">1月18日&nbsp;
			</label>
			<label class="no-cce no-ihbri no-nzlc no-ihvan no-els no-bloom no-ilac no-sgic no-umc no-ilsc no-kaplan" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m1 y2021 school-date"
				name="入学日変更・変更後" value="2021/1/25" required="">1月25日&nbsp;
			</label>
			<br/>
			<label class="no-cce no-nzlc no-ihvan no-els no-bloom no-umc no-kaplan" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m2 y2021 school-date"
			...
			<label class="no-cce no-ihbri no-ihvan no-els no-bloom no-sgic no-umc no-ilsc no-kaplan" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m2 y2021 school-date"
				name="入学日変更・変更後" value="2021/2/15" required="">2月15日&nbsp;
			</label>
			<label class="no-cce no-nzlc no-ihvan no-els no-bloom no-ilac no-sgic no-umc no-ilsc no-kaplan" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m2 y2021 school-date"
				name="入学日変更・変更後" value="2021/2/22" required="">2月22日&nbsp;
			</label>
			<br/>
			<label class="no-cce no-ihbri no-nzlc no-ihvan no-els no-bloom no-umc no-kaplan" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m3 y2021 school-date"
				name="入学日変更・変更後" value="2021/3/1" required="">3月1日&nbsp;
			</label>
			<label class="no-cce no-ihbri no-nzlc no-ihvan no-bloom no-ilac no-sgic no-ilsc no-kaplan" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m3 y2021 school-date"
			...
			<label class="no-cce no-ihbri no-ihvan no-els no-bloom no-umc no-kaplan" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m3 y2021 school-date"
				name="入学日変更・変更後" value="2021/3/29" required="">3月29日&nbsp;
			</label>
			<br/>
 -->			<label class="no-cce no-nzlc no-ihvan no-bloom no-ilac no-sgic no-ilsc no-kaplan" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m4 y2021 school-date"
			...
			<br/>
			<label class="no-cce no-ihbri no-nzlc no-ihvan no-bloom no-ilac no-sgic no-ilsc no-kaplan" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m5 y2021 school-date"
			...
			<br/>
			<label class="no-cce no-nzlc no-ihvan no-els no-bloom no-sgic no-umc no-ilsc no-kaplan" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m6 y2021 school-date"
			...
			<br/>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-sgic no-ilsc no-kaplan no-ihbri no-ilsc no-umc no-els" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m7 y2021 school-date"
				name="入学日変更・変更後" value="2021/7/5" required="">7月5日&nbsp;
			</label>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-ilac no-sgic no-ilsc no-kaplan no-ihbri no-ilsc no-umc no-els" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m7 y2021 school-date"
				name="入学日変更・変更後" value="2021/7/12" required="">7月12日&nbsp;
			</label>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-umc no-els" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m7 y2021 school-date"
				name="入学日変更・変更後" value="2021/7/19" required="">7月19日&nbsp;
			</label>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-sgic no-ilac no-ilsc no-kaplan no-ihbri no-ilsc" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m7 y2021 school-date"
				name="入学日変更・変更後" value="2021/7/26" required="">7月26日&nbsp;
			</label>
			<br/>
			<label class="no-cce no-ihvan no-bloom no-sgic no-ilsc no-kaplan no-ihbri no-ilsc no-umc no-els" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m8 y2021 school-date"
				name="入学日変更・変更後" value="2021/8/2" required="">8月2日&nbsp;
			</label>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-ilac no-sgic no-ilsc no-kaplan no-umc no-els" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m8 y2021 school-date"
				name="入学日変更・変更後" value="2021/8/9" required="">8月9日&nbsp;
			</label>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-ihbri no-umc no-els" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m8 y2021 school-date"
				name="入学日変更・変更後" value="2021/8/16" required="">8月16日&nbsp;
			</label>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-ilac no-sgic no-ilsc no-kaplan no-ihbri no-ilsc" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m8 y2021 school-date"
				name="入学日変更・変更後" value="2021/8/23" required="">8月23日&nbsp;
			</label>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-sgic no-ilsc no-kaplan no-umc no-els" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m8 y2021 school-date"
				name="入学日変更・変更後" value="2021/8/30" required="">8月30日&nbsp;
			</label>
			<br/>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-sgic no-ilsc no-kaplan no-umc no-els no-ihbri no-ilac" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m9 y2021 school-date"
				name="入学日変更・変更後" value="2021/9/6" required="">9月6日&nbsp;
			</label>
			<label class="no-cce no-ihvan no-bloom no-els no-ihbri no-umc" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m9 y2021 school-date"
				name="入学日変更・変更後" value="2021/9/13" required="">9月13日&nbsp;
			</label>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-sgic no-kaplan no-ilsc no-ilac" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m9 y2021 school-date"
				name="入学日変更・変更後" value="2021/9/20" required="">9月20日&nbsp;
			</label>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-sgic no-ilsc no-kaplan no-umc no-els no-ihbri" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m9 y2021 school-date"
				name="入学日変更・変更後" value="2021/9/27" required="">9月27日&nbsp;
			</label>
			<br/>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-sgic no-ilsc no-kaplan no-umc no-els no-ihbri no-ilac" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m10 y2021 school-date"
				name="入学日変更・変更後" value="2021/10/4" required="">10月4日&nbsp;
			</label>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-kaplan no-umc no-els" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m10 y2021 school-date"
				name="入学日変更・変更後" value="2021/10/11" required="">10月11日&nbsp;
			</label>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-sgic no-kaplan no-ilsc no-ihbri no-ilac" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m10 y2021 school-date"
				name="入学日変更・変更後" value="2021/10/18" required="">10月18日&nbsp;
			</label>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-sgic no-ilsc no-kaplan no-umc no-els no-ihbri" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m10 y2021 school-date"
				name="入学日変更・変更後" value="2021/10/25" required="">10月25日&nbsp;
			</label>
			<br/>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-sgic no-ilsc no-kaplan no-umc no-els no-ilac" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m11 y2021 school-date"
				name="入学日変更・変更後" value="2021/11/1" required="">11月1日&nbsp;
			</label>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-kaplan no-umc no-els no-ihbri" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m11 y2021 school-date"
				name="入学日変更・変更後" value="2021/11/8" required="">11月8日&nbsp;
			</label>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-sgic no-ilsc no-kaplan no-ihbri no-ilac" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m11 y2021 school-date"
				name="入学日変更・変更後" value="2021/11/15" required="">11月15日&nbsp;
			</label>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-sgic no-ilsc no-kaplan no-umc no-els" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m11 y2021 school-date"
				name="入学日変更・変更後" value="2021/11/22" required="">11月22日&nbsp;
			</label>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-sgic no-ilsc no-kaplan no-umc no-els no-ihbri no-ilac" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m11 y2021 school-date"
				name="入学日変更・変更後" value="2021/11/29" required="">11月29日&nbsp;
			</label>
			<br/>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-kaplan no-umc no-els no-ihbri" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m12 y2021 school-date"
				name="入学日変更・変更後" value="2021/12/6" required="">12月6日&nbsp;
			</label>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-sgic no-ilsc no-kaplan no-ihbri no-ilac" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m12 y2021 school-date"
				name="入学日変更・変更後" value="2021/12/13" required="">12月13日&nbsp;
			</label>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-sgic no-ilsc no-kaplan no-umc no-els no-ihbri" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m12 y2021 school-date"
				name="入学日変更・変更後" value="2021/12/20" required="">12月20日&nbsp;
			</label>
			<label class="no-cce no-nzlc no-ihvan no-bloom no-sgic no-ilsc no-kaplan no-umc no-els no-ihbri no-ilac" style="width: 85px;display: inline-block;">
				&nbsp;<input type="radio" class="m12 y2021 school-date"
				name="入学日変更・変更後" value="2021/12/27" required="">12月27日&nbsp;
			</label>
			<br/>
			<br/>

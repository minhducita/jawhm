...
<head>
    ...
    <meta name="description" content="ワーキングホリデー（ワーホリ）協定国の最新のビザ取得方法や渡航情報などを発信しています。年間25,000人以上の方に、セミナーに参加頂いています。また、ワーキングホリデー（ワーホリ）をされる方向けの各種無料セミナーを開催しています。オーストラリア、ニュージーランド、カナダ、韓国、フランス、ドイツ、イギリス、アイルランド、デンマーク、台湾、香港でワーキングホリデー（ワーホリ）ビザの取得が可能です。ワーキングホリデー（ワーホリ）ビザ以外に学生ビザでの留学などもお手伝い可能です。ワーホリなら日本ワーキングホリデー協会" />
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-KKVVF9Q');
    </script>
...
<body id="top">
    ...
    <div class="wrapper mobile-wrapper">
        <div id="header-box-new">
            <h1 id="header" class="header-new" style="color:white;font-size:7pt;padding-top:12px;">【&nbsp;ワーキングホリデーはワーホリ協会&nbsp;】
                <a href="/"><img src="/images/mobile/mobile-new-header.gif" class="responsive-img" alt="日本ワーキング・ホリデー協会 富山オフィスセミナー開催中！！"></a>
            </h1>
            <a href="/member/">
                <span style="display: block;width: 68px;position: absolute;right: 5px;top: 9px;">
                    <img src="/sp/images/btn-log.png" class="responsive-img" alt="">
                </span>
            </a>
        </div>
        ...
        <section class="topContents">
            <div class="mainBtn">
                <ul>
                    <li><a href="/seminar"><img src="/sp/images/mn9.png" alt="pen"></a></li>
                    <li><a href="/mem2/register.php"><img src="/sp/images/mn1.png" alt="jawhm"></a></li>

                    <li><a href="/system.html"><img src="/sp/images/mn2.png" alt="book"></a></li>
                    <li><a href="/country/"><img src="/sp/images/mn3.png" alt="world"></a></li>

                    <li><a href="/start.html"><img src="/sp/images/mn5.png" alt="flight"></a></li>
                    <li><a href="/katsuyou.html"><img src="/sp/images/mn6.png" alt="valet"></a></li>

                    <li><a href="/qa.html"><img src="/sp/images/mn7.png" alt="chat"></a></li>
                    <li><a href="/office/"><img src="/sp/images/mn8.png" alt="access"></a></li>
                </ul>
            </div><!-- /.mainBtn -->
            <div>
                <a href="/seminar/ser/know/first"><img src="/sp/images/bnr_seminar.jpg" alt="初心者向セミナー開催中"></a>
            </div>
        ...
        <section class="menuBox menu3">
            ...
            <ul class="visaMenu">
                ...
                <li><a href="/country"><img src="/sp/images/visa_all.png" alt="全てビザ"></a></li>
            </ul>
        </section>

        <div class="seminar mgb20">
            <a href="/seminar/seminar"><img src="/sp/images/bnr_seminar.png" alt=""></a>
        </div>
